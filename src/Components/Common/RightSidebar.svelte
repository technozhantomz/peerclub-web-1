<script>
	...
	let leftsidbarSizeType = 'sm-hover';
	...
	function changeLayout(value) {
		if (document.documentElement) document.documentElement.setAttribute('data-layout', value);
	}

	function changeLayoutMode(value) {
		if (document.documentElement) document.documentElement.setAttribute('data-layout-mode', value);
	}

	function changeLayoutWidth(value) {
		if (document.documentElement) document.documentElement.setAttribute('data-layout-width', value);
	}

	function changeLeftsidebarSizeType(value) {
		if (document.documentElement) document.documentElement.setAttribute('data-sidebar-size', value);
	}
	...
	function changeTopbarTheme(value) {
		if (document.documentElement) document.documentElement.setAttribute('data-topbar', value);
	}
	function changeLeftsidebarViewType(value) {
		if (document.documentElement) document.documentElement.setAttribute('data-layout-style', value);
	}
	function changeSidebarTheme(value) {
		if (document.documentElement) document.documentElement.setAttribute('data-sidebar', value);
	}
...
<div>
	...
	>
										...
										<span class="d-flex gap-1 h-100">
											<span class="flex-shrink-0">
												<span class="bg-light d-flex h-100 flex-column gap-1 p-1">
													<span class="d-block p-1 px-2 bg-soft-primary rounded mb-2" />
										...
										<span class="d-flex gap-1 h-100">
											<span class="flex-shrink-0">
												<span class="bg-soft-light d-flex h-100 flex-column gap-1 p-1">
													<span class="d-block p-1 px-2 bg-soft-light rounded mb-2" />
								...
								<div class="col-4">
									<div class="form-check card-radio">
										<input
											...
											value="lg"
											on:change={() => changeBodyAttribute('data-layout-width', 'lg')}
								...
								<div class="col-4">
									<div class="form-check card-radio">
										<input
											...
											value="boxed"
											on:change={() => changeBodyAttribute('data-layout-width', 'boxed')}
						...
						<div id="layout-position">
							...
							<div class="btn-group radio" role="group">
								<input
									...
									value="fixed"
									on:change={() => changeBodyAttribute('data-layout-width', 'fixed')}
								...
								<input
									...
									value="scrollable"
									on:change={() => changeBodyAttribute('data-layout-width', 'scrollable')}
									...
									<div class="form-check sidebar-setting card-radio">
										...
										<Label class="form-check-label p-0 avatar-md w-100" for="sidebar-size-compact">
											<span class="d-flex gap-1 h-100">
												<span class="flex-shrink-0">
													<span class="bg-light d-flex h-100 flex-column gap-1 p-1">
														<span class="d-block p-1 bg-soft-primary rounded mb-2" />
								...
								<div class="col-4">
									<div class="form-check sidebar-setting card-radio">
										<input
											...
											value="sm-hover"
											on:change={() => changeBodyAttribute('data-sidebar-size', 'sm-hover')}
								...
								<div class="col-4">
									<div class="form-check sidebar-setting card-radio">
										<input
											...
											value="default"
											on:change={() => changeBodyAttribute('data-layout-style', 'default')}
								...
								<div class="col-4">
									<div class="form-check sidebar-setting card-radio">
										<input
											...
											value="detached"
											on:change={() => changeBodyAttribute('data-layout-style', 'detached')}
											checked={leftSidebarViewType == 'detached'}
										/>
										<Label class="form-check-label p-0 avatar-md w-100" for="sidebar-view-detached">
											<span class="d-flex h-100 flex-column">
												<span class="bg-light d-flex p-1 gap-1 align-items-center px-2">
													<span class="d-block p-1 bg-soft-primary rounded me-1" />
													<span class="d-block p-1 pb-0 px-2 bg-soft-primary ms-auto" />
								...
								<div class="d-flex gap-2 flex-wrap img-switch p-2 px-3 bg-light rounded">
									<div class="form-check sidebar-setting card-radio">
										<input
											...
											value="gradient"
											on:change={() => changeBodyAttribute('data-sidebar', 'gradient')}
									...
									<div class="form-check sidebar-setting card-radio">
										<input
											...
											value="gradient-2"
											on:change={() => changeBodyAttribute('data-sidebar', 'gradient-2')}
									...
									<div class="form-check sidebar-setting card-radio">
										<input
											...
											value="gradient-3"
											on:change={() => changeBodyAttribute('data-sidebar', 'gradient-3')}
									...
									<div class="form-check sidebar-setting card-radio">
										<input
											...
											value="gradient-4"
											on:change={() => changeBodyAttribute('data-sidebar', 'gradient-4')}
							...
							<div class="d-flex gap-2 flex-wrap img-switch">
								<div class="form-check sidebar-setting card-radio">
									<input
										...
										id="sidebarimg-none"
										value="none"
										on:change={() => changeBodyAttribute('data-sidebar-image', 'none')}
								...
								<div class="form-check sidebar-setting card-radio">
									<input
										...
										id="sidebarimg-01"
										value="img-1"
										on:change={() => changeBodyAttribute('data-sidebar-image', 'img-1')}
								...
								<div class="form-check sidebar-setting card-radio">
									<input
										...
										id="sidebarimg-02"
										value="img-2"
										on:change={() => changeBodyAttribute('data-sidebar-image', 'img-2')}
								...
								<div class="form-check sidebar-setting card-radio">
									<input
										...
										id="sidebarimg-03"
										value="img-3"
										on:change={() => changeBodyAttribute('data-sidebar-image', 'img-3')}
								...
								<div class="form-check sidebar-setting card-radio">
									<input
										...
										id="sidebarimg-04"
										value="img-4"
										on:change={() => changeBodyAttribute('data-sidebar-image', 'img-4')}
		...
		<div class="offcanvas-footer border-top p-3 text-center">
			<div class="row">
				<div class="col-12">
					<a href="https://1.envato.market/peerclub-admin" type="button" class="btn btn-primary w-100"
						>Preview</a
					>
				</div>
			</div>
