...
<svelte:head>
	<title>Scrollbar | Peer Club Dashboard</title>
</svelte:head>
		...
		<Row>
						...
						<div class="mx-n3">
							<div data-simplebar style="max-height: 220px;" class="px-3">
								...
								<p>
									...
									members of the same family. Their separate existence is a myth. For science,
								...
								<p>
									...
									common words. Everyone realizes why a new common language would be desirable: one
									could refuse to pay expensive translators. To achieve this, it would be necessary
									to have uniform grammar, pronunciation and more common words.
								</p>
								<p>
									Their separate existence is a myth. For science, music, sport, etc, Europe uses
									the same vocabulary. The languages only differ in their grammar, their
			...
			<Col xl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>data-simplebar-auto-hide="false"</code>
							attribute and add
				...
				<Row>
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code>data-simplebar-track="primary"</code> attribute to set primary color simplebar
									track.
								</p>
								...
								<div class="mx-n3">
									...
									>
											...
											<div class="d-flex">
												...
												<div class="flex-shrink-0 ms-2">
													<div class="fs-12 text-muted">
														<i class="mdi mdi-clock-outline" /> 30 min ago
													</div>
												</div>
											</div>
										</a>
										...
										<a href="#!" class="text-reset notification-item d-block dropdown-item active">
											<div class="d-flex">
												<div class="flex-shrink-0 avatar-xs me-3">
													<img src={avatar2} class="rounded-circle img-fluid" alt="user-pic" />
												</div>
												<div class="flex-grow-1 text-muted">
												...
												<div class="flex-shrink-0 ms-2">
													<div class="fs-12 text-muted">
														<i class="mdi mdi-clock-outline" /> 01 hr ago
													</div>
												</div>
											</div>
										</a>
										...
										<a href="#!" class="text-reset notification-item d-block dropdown-item">
											<div class="d-flex">
												<div class="flex-shrink-0 avatar-xs me-3">
													...
													>
														<i class="ri-message-2-fill" />
													</span>
												</div>
												<div class="flex-grow-1 text-muted">
													<p class="m-0">
														You have received <span class="fw-semibold text-success">20</span> new messages
														in the conversation
													</p>
												</div>
												<div class="flex-shrink-0 ms-2">
													<div class="fs-12 text-muted">
														<i class="mdi mdi-clock-outline" /> 02 hrs ago
													</div>
												</div>
											</div>
										</a>
										...
										<a href="#!" class="text-reset notification-item d-block dropdown-item">
											<div class="d-flex">
												<div class="flex-shrink-0 avatar-xs me-3">
													<img src={avatar8} class="rounded-circle img-fluid" alt="user-pic" />
												</div>
												<div class="flex-grow-1 text-muted">
										...
										<div class="text-center my-2">
											<a href={null} class="text-success"
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code>data-simplebar-track="secondary"</code> attribute to set secondary color
									simplebar track.
								</p>
								...
								<div class="mx-n3">
									...
									>
										<div class="list-group list-group-flush">
											<a href={null} class="list-group-item text-muted py-3">
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code>data-simplebar-track="success"</code> attribute to set success color simplebar
									track.
								</p>
											...
											<li class="list-group-item py-3">
												<div class="d-flex align-items-center">
													...
													<div class="flex-shrink-0 mx-3">
														<i class="ri-arrow-right-fill text-muted" />
													</div>
							...
							<CardBody>
								...
								<div class="mx-n3">
									<div
										data-simplebar
										data-simplebar-auto-hide="false"
										data-simplebar-track="info"
										style="max-height: 238px;"
									>
										<ol class="list-group list-group-flush list-group-numbered">
											<li class="list-group-item d-flex align-items-center">
												A list item
												<Badge class="ms-auto" color="success">Paid</Badge>
											</li>
											<li class="list-group-item d-flex align-items-center">
												A second list item
												<Badge class="ms-auto" color="danger">Refund</Badge>
											</li>
											<li class="list-group-item d-flex align-items-center">
												A third list item
												<Badge class="ms-auto" color="success">Paid</Badge>
											...
											<li class="list-group-item d-flex align-items-center">
												A Fifth list item
												<Badge class="ms-auto" color="warning">Inprogress</Badge>
											</li>
											<li class="list-group-item d-flex align-items-center">
												A Sixth list item
												<Badge class="ms-auto" color="success">Paid</Badge>
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code>data-simplebar-track="warning"</code> attribute to set warning color simplebar
									track.
								</p>
					...
					<div class="col-xl-4 col-lg-6">
						<Card>
							...
							<CardBody>
								<p class="text-muted">
									Use <code>data-simplebar-track="danger"</code> attribute to set danger color simplebar
									track.
								</p>
								...
								<div class="mx-n3">
									<div
										data-simplebar
										data-simplebar-auto-hide="false"
										data-simplebar-track="danger"
										style="max-height: 220px;"
										class="px-3"
									>
										<a href={null} class="d-flex align-items-center py-2">
											<div class="flex-shrink-0 avatar-xs me-3">
										...
										<ul class="list-group list-group-flush">
											<li class="list-group-item">
												<div>
													...
													<p class="text-muted mb-4">
														It will be as simple as in fact, It will seem like simplified
													</p>
													<div class="d-flex align-items-start">
														<div class="flex-grow-1">
														...
														<div class="flex-shrink-0">
															<div class="hstack gap-3">
																<div data-bs-toggle="tooltip" data-bs-placement="top" title="Like">
																	<a href={null} class="text-muted"
																		><i class="ri-thumb-up-line" /></a
																	>
																</div>
																<div class="vr" />
																<div
																	...
																	title="Comment"
																>
																	<a href={null} class="text-muted"><i class="ri-discuss-line" /></a
																	>
																</div>
																<div class="vr" />
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a class="dropdown-item" href={null}>Action</a>
																		<a class="dropdown-item" href={null}>Another action</a>
																		<a class="dropdown-item" href={null}>Something else here</a>
																	</div>
																</div>
															</div>
														</div>
											...
											<li class="list-group-item">
												<div>
													...
													<div class="d-flex align-items-start">
														<div class="flex-grow-1">
															<h5 class="fs-15 mb-0">Joyce White</h5>
														</div>
											...
											<li class="list-group-item">
												<div>
													...
													<div class="d-flex align-items-start">
														<div class="flex-grow-1">
															<h5 class="fs-15 mb-0">Etta Smith</h5>
														</div>
