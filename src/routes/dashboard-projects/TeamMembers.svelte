...
<Col xxl={4}>
	<Card>
		<CardHeader class="align-items-center d-flex card-height-100">
				...
				<Dropdown class="card-header-dropdown">
					<DropdownToggle tag="a" class="text-reset dropdown-btn p-0" color="" role="button">
						<span class="fw-semibold text-uppercase fs-13">Sort by: </span><span class="text-muted"
							>Last 30 Days<i class="mdi mdi-chevron-down ms-1" /></span
						>
					</DropdownToggle>
							...
							<tr>
								<td class="d-flex">
									...
									<div>
										...
										<p class="fs-13 mb-0 text-muted">{item.position}</p>
									</div>
								</td>
								<td>
