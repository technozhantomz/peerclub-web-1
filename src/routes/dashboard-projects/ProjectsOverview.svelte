<script>
	...
	import ProjectsOverviewCharts from './ProjectsOverviewCharts.svelte';
</script>
	...
	<Col xl={12}>
		<Card>
			...
			<CardBody class="p-0 pb-2">
				<div>
					<div dir="ltr" class="apex-charts">
						<ProjectsOverviewCharts dataColors={['--vz-primary', '--vz-warning', '--vz-success']} />
					</div>
				</div>
			</CardBody>
		</Card>
