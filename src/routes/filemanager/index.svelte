...
<svelte:head>
	<title>File Manager | Peer Club Dashboard</title>
</svelte:head>
				...
				<div class="p-3 d-flex flex-column h-100">
					...
					<div class="mt-3 mx-n4 px-4 file-menu-sidebar-scroll" data-simplebar>
						<ul class="list-unstyled file-manager-menu">
							...
							<li>
								<a href="#!"
									><i class="ri-file-list-2-line align-bottom me-2" />
									<span class="file-list-link">Documents</span></a
								>
							</li>
							<li>
								<a href="#!"
									><i class="ri-image-2-line align-bottom me-2" />
									<span class="file-list-link">Media</span></a
								>
							</li>
							<li>
								<a href="#!"
									><i class="ri-history-line align-bottom me-2" />
									<span class="file-list-link">Recents</span></a
								>
							</li>
							<li>
								<a href="#!"
									><i class="ri-star-line align-bottom me-2" />
									<span class="file-list-link">Important</span></a
								>
							</li>
							<li>
								<a href="#!"
									><i class="ri-delete-bin-line align-bottom me-2" />
				...
				<div class="mx-n3 pt-4 px-4 file-manager-content-scroll" data-simplebar>
						...
						<Row class="justify-content-beetwen g-2">
							...
							<Col class="col-auto">
								<div class="d-flex gap-2 align-items-start mb-4">
									...
									<button class="btn btn-primary create-folder-modal text-nowrap"
										><i class="ri-add-line align-bottom me-1" /> Create Folders</button
									>
								</div>
							</Col>
						</Row>
					...
					<div>
						<div class="d-flex align-items-center mb-3">
							...
							<div class="flex-shrink-0">
								<button class="btn btn-primary createFile-modal"
									><i class="ri-add-line align-bottom me-1" /> Create File</button
								>
							</div>
						</div>
								...
								<tbody id="file-list">
									{#each data.recentFile as item}
										<tr>
											<td>
												<input
													class="form-control filelist-id"
													type="hidden"
													value="1"
													id="filelist-1"
												/>
											...
											<td>
												<div class="d-flex gap-3 justify-content-center">
													...
													<Dropdown>
														...
														<DropdownMenu class="dropdown-menu-end">
															<DropdownItem class="viewfile-list" on:click={hangleClick(item)}
																>View</DropdownItem
															>
							...
							<div class="alert alert-danger d-flex align-items-center mb-0">
								...
								<div class="flex-grow-1 ms-3">
									...
									<button class="btn btn-sm btn-danger"
										><i class="ri-upload-cloud-line align-bottom" /> Upgrade Now</button
									>
								</div>
							</div>
						</div>
					...
					<div id="file-overview" class="h-100">
						<div class="d-flex h-100 flex-column">
							...
							<div class="pb-3 border-bottom border-bottom-dashed mb-3">
								...
								<button type="button" class="btn btn-icon btn-sm btn-ghost-success float-end fs-16"
									><i class="ri-share-forward-line" /></button
								>
										...
										<table class="table table-borderless table-nowrap table-sm">
											<tbody>
												...
												<tr>
													...
													<td class="share-path">peerclub:\Documents\</td>
												</tr>
											</tbody>
										</table>
									</div>
							...
							<div class="mt-auto border-top border-top-dashed py-3">
								<div class="hstack gap-2">
									<button type="button" class="btn btn-soft-primary w-100"
										><i class="ri-download-2-line align-bottom me-1" /> Download</button
									>
									<button type="button" class="btn btn-soft-danger w-100 remove-file-overview"
										><i class="ri-close-fill align-bottom me-1" /> Delete</button
									>
								</div>
							</div>
						</div>
