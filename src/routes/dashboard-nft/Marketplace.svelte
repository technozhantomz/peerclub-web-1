							...
							<div class="w-100">
								<div class="d-flex align-items-center">
									...
									<div class="ms-3 flex-grow-1">
										<h5 class="fs-16 mb-1">Trendy Upcoming Event</h5>
										<p class="text-muted mb-0">Events</p>
									</div>
									...
									<Dropdown>
										...
										<DropdownMenu class="dropdown-menu-end" end>
											<DropdownItem href=""
												><i class="ri-twitter-fill text-primary align-bottom me-1" /> Twitter</DropdownItem
											>
											<DropdownItem href=""
												><i class="ri-facebook-circle-fill text-info align-bottom me-1" /> Facebook</DropdownItem
											>
											<DropdownItem href=""
												><i class="ri-google-fill text-danger align-bottom me-1" /> Google</DropdownItem
											>
										</DropdownMenu>
									</Dropdown>
								</div>
								...
								<h3 class="ff-secondary fw-bold mt-4">
									<i class="mdi mdi-ethereum text-primary" /> 346.12 KSH
								</h3>
								<p class="text-success mb-3">+586.85 (40.6%)</p>

								<p class="text-muted fs-15">
									NFT Membership for Events is a digital asset that is collectable, unique, and non-transferrable.
								</p>

								<div class="d-flex align-items-end justify-content-between mt-4">
									<div>
										<p class="fs-14 text-muted mb-1">Current Bid</p>
										<h4 class="fs-20 ff-secondary fw-semibold mb-0">342.74 KSH</h4>
									</div>

									<div>
										<p class="fs-14 text-muted mb-1">Highest Bid</p>
										<h4 class="fs-20 ff-secondary fw-semibold mb-0">346.67 KSH</h4>
									</div>
								</div>
								...
								<Row class="mt-4 pt-2">
									<Col>
										<Link
											...
											class="btn btn-primary w-100">View Details</Link
										>
									</Col>
									<Col>
