...
<svelte:head>
	<title>Two Step Verification | Homepesa Mega platform</title>
</svelte:head>
											...
											<Col class="col-3">
												<div class="mb-3">
													...
													<input
														...
														on:keyup={({ target: { value } }) => moveToNext(value, 2)}
														maxLength="1"
														id="digit1-input"
													/>
												</div>
											...
											<Col class="col-3">
												<div class="mb-3">
													...
													<input
														type="text"
														class="form-control form-control-lg bg-light border-light text-center"
														on:keyup={({ target: { value } }) => moveToNext(value, 3)}
														maxLength="1"
														id="digit2-input"
													/>
												</div>
											...
											<Col class="col-3">
												<div class="mb-3">
													...
													<input
														type="text"
														class="form-control form-control-lg bg-light border-light text-center"
														on:keyup={({ target: { value } }) => moveToNext(value, 4)}
														maxLength="1"
														id="digit3-input"
													/>
												</div>
