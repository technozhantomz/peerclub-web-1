<script>
	import { Card, Col, Container, Input, Label, Row, Button } from 'sveltestrap';
								...
								<div class="p-lg-5 p-4">
									...
									<div class="mt-4">
										<form action="/">
											...
											<div class="mb-3">
												<div class="float-end">
													<Link
														...
														class="text-muted">Forgot password?</Link
													>
												</div>
											...
											<div class="mt-4">
												<Button color="success" class="w-100" type="submit">Sign In</Button>
											</div>
											...
											<div class="mt-4 text-center">
												...
												<div>
													<Button color="primary" class="btn-icon me-1"
														><i class="ri-facebook-fill fs-16" /></Button
													>
													<Button color="danger" class="btn-icon me-1"
														><i class="ri-google-fill fs-16" /></Button
													>
													<Button color="dark" class="btn-icon me-1"
														><i class="ri-github-fill fs-16" /></Button
													>
													<Button color="info" class="btn-icon"
									...
									<div class="mt-5 text-center">
										<p class="mb-0">
											Don't have an account ? <a
												href="/authenticationInner/register/auth-signup-cover"
			...
			<Row>
				<Col lg={12}>
					<div class="text-center">
						<p class="mb-0">
							&copy; {new Date().getFullYear()} Homepesa Club. Crafted with
							<i class="mdi mdi-heart text-danger" /> by Homepesa
						</p>
					</div>
				</Col>
			</Row>
