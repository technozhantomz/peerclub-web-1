...
<svelte:head>
	<title>Log Out | Homepesa Mega platform</title>
</svelte:head>
					...
					<Row>
						<Col lg={12}>
							<div class="text-center mt-sm-5 mb-4 text-white-50">
								<div>
									<Link href="/dashboard-nft" class="d-inline-block auth-logo">
							...
							<Card class="mt-4">
								<CardBody class="p-4 text-center">
									...
									<div class="mt-4 pt-2">
										...
										<p class="text-muted">
											Thank you for using <span class="fw-semibold">Homepesa Club</span>
										</p>
										<div class="mt-4">
											<Link
