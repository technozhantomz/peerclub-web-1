...
<svelte:head>
	<title>Reset Password | Homepesa Mega platform</title>
</svelte:head>
<ParticlesAuth>
					...
					<Card class="mt-4">
						<CardBody class="p-4">
							<div class="text-center mt-2">
								...
								<p class="text-muted">Reset password with Homepesa club</p>
							...
							<Alert class="alert-borderless alert-warning text-center mb-2 mx-2" role="alert">
