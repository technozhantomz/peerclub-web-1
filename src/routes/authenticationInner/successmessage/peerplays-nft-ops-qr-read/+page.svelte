...
<svelte:head>
	<title>NFT Ops Message | Homepesa Mega platform</title>
</svelte:head>
							...
							<CardBody class="p-4 text-center">
								...
								<div class="mt-4 pt-2">
									...
									<p class="text-muted mx-4">
										User granted access to the event.
									</p>
									<div class="mt-4">
										<Link
											href="/calendar/apps-calendar/scanpassqr"
											class="btn btn-success w-100">Back to Event Entrance</Link
										>
									</div>
								</div>
							</CardBody>
