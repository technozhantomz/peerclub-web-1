				...
				>
					...
					>
											...
											>
												...
												<table style="width:100%;" cellspacing="0" cellpadding="0">
													<thead style="text-align: left;">
														<th style="padding: 8px;border-bottom: 1px solid #e9ebec;"
															>Product Details</th
														>
													...
													<tbody>
														<tr>
															...
															<td style="padding: 8px; font-size: 13px;"> 02 </td>
															<td style="padding: 8px; font-size: 13px;"> $239.98 </td>
														</tr>
														<tr>
															<td style="padding: 8px; font-size: 13px;">
																<h6 style="margin-bottom: 2px; font-size: 14px;">
															...
															<td style="padding: 8px; font-size: 13px;"> 01 </td>
															<td style="padding: 8px; font-size: 13px;"> $94.99 </td>
														</tr>
														<tr>
															<td
																colspan="2"
														...
														<tr>
															...
															<th style="padding: 8px; font-size: 13px;"> $9.50 </th>
														</tr>
														<tr>
															<td
																colspan="2"
															...
															<th style="padding: 8px; font-size: 13px;"> $15.26 </th>
														</tr>
														<tr>
															<td
																colspan="2"
															...
															<th style="padding: 8px; font-size: 13px;"> $20.78 </th>
														</tr>
														<tr>
															<td
																colspan="2"
										...
										>
											...
											>
												<p
													style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;"
												>
													Wl'll send you shipping confirmation when your item(s) are on the way! We
						...
						<div style="text-align: center; margin: 28px auto 0px auto;">
							...
							>
								2022 Peer Club. Design & Develop by Peerplays
							</p>
						</div>
					</div>
				</td>
