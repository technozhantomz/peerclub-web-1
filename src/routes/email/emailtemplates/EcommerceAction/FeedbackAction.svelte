...
<Row>
	...
	<Col class="col-12">
		...
		>
			...
			>
				<td
					style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0;"
					valign="top"
				/>
				<td
					class="container"
				...
				>
					...
					>
										...
										>
											...
											>
												...
												<p
													style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;line-height: 1.5;"
												>
													Thank you so much for providing 5 stars review It really means a lot to
													us. Your review motivates us to work even hard and provide top-notch
													features, support, and updates. You can share more details via the contact
													us so we can provide the best from our side in future updates. We are
													going to release the Vue and React version asap.
												</p>
												<p
													style="font-family: 'Roboto', sans-serif; margin-bottom: 8px; color: #878a99;line-height: 1.5;"
												>
													Feel free to get in touch with us anytime via support from the link below. <Link
														href="https://themeforest.net/item/peerclub-aspnet-core-admin-dashboard-template/36077495/support"
														target="_blank"
														>https://themeforest.net/item/peerclub-aspnet-core-admin-dashboard-template/36077495/support</Link
													>
												</p>
												<h6
						...
						<div style="text-align: center; margin: 28px auto 0px auto;">
							...
							>
								2023 Peer Club. Design & Develop by Homepesa
							</p>
						</div>
					</div>
				</td>
