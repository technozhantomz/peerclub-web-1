					...
					>
									...
									>
										...
										>
											...
											>
												<p style="margin-bottom: 13px; line-height: 1.5;">
													...
													forget it. Your Google Account password is used to access many Google
													products, like Gmail and YouTube.
												</p>
											</td>
										</tr>
										<tr
										...
										>
											...
											>
												...
												>
													<li>Open your account. You might need to sign in.</li>
													<li>Under "Security," select Signing in to Google.</li>
													<li>Choose Password. You might need to sign in again.</li>
													<li>Enter your new password, then select Change Password.</li>
												</ul>
											</td>
										</tr>
									</table>
						...
						<div style="text-align: center; margin: 28px auto 0px auto;">
							...
							<p style="color: #878a99;">
								Please send and feedback or bug info to <a href="!#" style="font-weight: 500px;"
									>info@peerclub.com</a
								>
							</p>
							<p
