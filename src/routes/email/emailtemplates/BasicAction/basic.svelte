				...
				>
					...
					>
									...
									>
										...
										>
											<td
												...
												valign="top"
											>
												I'm writing to let you know that I can't attend class for two weeks as I've
												had an accident and hurt my back. I'm afraid I also need to ask for an
												extension for next week's essay.
											</td>
										</tr>
										<tr
											style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;"
										>
											<td
												...
												valign="top"
											>
												Until then, my friend is going to record the lectures so I can listen to
												them at home. I will try to catch up with all the reading too. However, I
												don't think I can submit the essay next week. Is it possible to have an
												extension?
											</td>
										</tr>
										<tr
						...
						<div style="text-align: center; margin: 0px auto;">
							...
							>
								2023 Homepesa Club. Design & Develop by Homepesa
							</p>
						</div>
					</div>
				</td>
