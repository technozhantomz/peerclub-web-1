...
<Row>
	<Col lg={12}>
		<Card class="mt-n4 mx-n4 border-0">
			<div class="bg-soft-warning">
				<CardBody class="pb-0 px-4">
					<Row class="mb-3">
						<div class="col-md">
								...
								<div class="col-md-auto">
									<div class="avatar-md">
										<div class="avatar-title bg-white rounded-circle">
											<img src={slack} alt="" class="avatar-xs" />
										</div>
									</div>
								</div>
								<div class="col-md">
									<div>
										<h4 class="fw-bold">Peer Club - Admin & Dashboard</h4>
										<div class="hstack gap-3 flex-wrap">
											<div><i class="ri-building-line align-bottom me-1" /> Peerplays</div>
											<div class="vr" />
					...
					<Nav class="nav-tabs-custom border-bottom-0" role="tablist">
						<NavItem>
							<NavLink
