	...
	<div class="col-sm-auto">
		<div>
			<Link href="/projects/apps-projects-create" class="btn btn-success"
				><i class="ri-add-line align-bottom me-1" /> Add New
			</Link>
		</div>
	</div>
	<div class="col-sm">
					...
					<CardBody>
						<div class="d-flex flex-column h-100">
							...
							<div class="d-flex mb-2">
								...
								<div class="flex-grow-1">
									<h5 class="mb-1 fs-16">
										<Link href="/projects/apps-projects-overview" class="text-dark"
											>{item.label}</Link
										>
									</h5>
					...
					<CardBody>
						<div class={`p-3 mt-n3 mx-n3 bg-${item.cardHeaderClass} rounded-top`}>
							<div class="d-flex gap-1 align-items-center justify-content-end my-n2">
								<button type="button" class={`btn avatar-xs p-0 favourite-btn ${item.ratingClass}`}>
									<span class="avatar-title bg-transparent fs-15">
										<i class="ri-star-fill" />
									</span>
								</button>
