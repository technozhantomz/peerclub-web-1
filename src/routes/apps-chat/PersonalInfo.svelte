...
<Offcanvas isOpen={show} placement="end" class="offcanvas-end border-0 profile-details-canvas">
	<div class="profile-offcanvas p-0">
				...
				<div class="row g-0">
					<div class="col">
						<div class="btn nav-btn">
							<Button on:click={onCloseClick} color="" class="btn-close btn-close-white" />
						</div>
					</div>
					<div class="col-auto">
						<div class="user-chat-nav d-flex">
							...
							<Dropdown>
								<DropdownToggle class="btn nav-btn p-0 text-white" color="" tag="a">
		...
		<div class="p-3 text-center">
			{#if cuurentiseImg}
				<img src={cuurentiseImg} alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto" />
			{:else}
				<img src={userdummyimg} alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto" />
			{/if}
			...
			<div class="mt-3">
				...
				<p class="text-muted">
					<i class="ri-checkbox-blank-circle-fill me-1 align-bottom text-success" />
					Online
				</p>
			</div>
