		...
		<Card>
			<CardHeader class="border-0 align-items-center d-flex">
				...
				<div class="d-flex gap-1">
					<button type="button" class="btn btn-soft-secondary btn-sm"> 1H </button>
					<button type="button" class="btn btn-soft-secondary btn-sm"> 7D </button>
					<button type="button" class="btn btn-soft-secondary btn-sm"> 1M </button>
					<button type="button" class="btn btn-soft-secondary btn-sm"> 1Y </button>
						...
						<Col xs={6}>
							<div class="d-flex flex-wrap gap-4 align-items-center">
								...
								<p class="fw-medium text-muted mb-0">
									$75.69 <span class="text-success fs-13 ms-1">+1.99%</span>
								</p>
								<p class="fw-medium text-muted mb-0">
			...
			<div class="card-body p-0 pb-3">
				<div id="Market_chart" class="apex-charts" dir="ltr">
