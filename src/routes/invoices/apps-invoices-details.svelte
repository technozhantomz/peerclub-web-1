<svelte:head>
  <title>Invoice Details | Peer Club Dashboard</title>
</svelte:head>
<script>
	import { CardBody, Row, Col, Card, CardHeader, Container } from 'sveltestrap';
...
<div class="page-content">
	<Container fluid>
		...
		<Row class="justify-content-center">
			<Col xxl={9}>
				<Card id="demo">
					<CardHeader class="border-bottom-dashed p-4">
						<div class="d-sm-flex">
							...
							<div class="flex-shrink-0 mt-sm-0 mt-3">
								...
								<h6>
									...
									<span id="email">peerclub@peerplays.com</span>
								</h6>
								<h6>
									...
									<a
										...
										class="link-primary"
										target="_blank"
										id="website">www.peerplays.com</a
									>
								</h6>
								<h6 class="mb-0">
									<span class="text-muted fw-normal">Contact No: </span><span id="contact-no">
										+(01) 234 6789</span
									>
								</h6>
							</div>
						...
						<Row class="g-3">
							<Col sm={6}>
								...
								<p class="text-muted mb-1">
									<span>Phone: +</span><span id="billing-phone-no">(123) 456-7890</span>
								</p>
							...
							<Col sm={6}>
								...
								<p class="text-muted mb-1">
									<span>Phone: +</span><span id="shipping-phone-no">(123) 456-7890</span>
								</p>
							</Col>
							<!--end col-->
						</Row>
					...
					<CardBody class="p-4">
						...
						<div class="border-top border-top-dashed mt-2">
							<table class="table table-borderless table-nowrap align-middle mb-0 ms-auto" style="width:250px">
								<tbody>
									...
									<tr>
										<td>Discount <small class="text-muted">(PEERPLAYS15)</small></td>
						...
						<div class="hstack gap-2 justify-content-end d-print-none mt-4">
							<button type="submit" on:click={printInvoice} class="btn btn-success"><i class="ri-printer-line align-bottom me-1"></i> Print</button>
							<Link href="{null}" class="btn btn-primary"><i class="ri-download-2-line align-bottom me-1"></i> Send Invoice</Link>
						</div>
					</CardBody>
					<!--end card-body-->
				</Card>
