							...
							<div class="d-flex mb-3">
								<div class="flex-shrink-0 avatar-sm">
									<div class="avatar-title bg-light rounded">
										<img src={subItem.img} alt="" class="avatar-xxs" />
									</div>
								</div>
								<div class="flex-grow-1 ms-3">
									<h5 class="fs-16 mb-1">{subItem.label}</h5>
									<p class="text-muted mb-2">
										{subItem.caption}
									</p>
								</div>
								<div>
									<Link href="" class="badge badge-soft-primary"
										>Visit Website <i class="ri-arrow-right-up-line align-bottom" /></Link
									>
								</div>
							</div>
						...
						<CardBody class="border-top border-top-dashed">
							<div class="d-flex">
								<div class="flex-grow-1">
									<h6 class="mb-0">
										{subItem.rating}
										<i class="ri-star-fill align-bottom text-warning" />
									</h6>
								</div>
								<h6 class={'flex-shrink-0 text-' + subItem.dateClass + ' mb-0'}>
				...
				{#each item.subItem as subItem}
					<Card class="mb-2">
						<CardBody>
							...
							<h6 class="text-muted mb-0">
								{subItem.amount}
								<span class="badge badge-soft-success">{subItem.percentage}</span>
							</h6>
						</CardBody>
						<CardBody class="border-top border-top-dashed">
							<div class="d-flex">
				...
				{#each item.subItem as subItem}
					<Card class="mb-2 ribbon-box ribbon-fill right">
						<div class="ribbon ribbon-info shadow-none">
							<i class="ri-flashlight-fill me-1" />{subItem.ribbonNumber}
						</div>
						<CardBody>
							<div class="d-flex mb-3">
								<div class="flex-shrink-0 avatar-sm">
