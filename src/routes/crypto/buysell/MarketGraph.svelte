...
<Col xxl={9}>
	<Card class="card-height-100">
		<CardHeader class="border-0 align-items-center d-flex">
			...
			<div>
				<button type="button" class="btn btn-soft-secondary btn-sm me-1"> 1H </button>
				<button type="button" class="btn btn-soft-secondary btn-sm me-1"> 7D </button>
				<button type="button" class="btn btn-soft-secondary btn-sm me-1"> 1M </button>
				<button type="button" class="btn btn-soft-secondary btn-sm me-1"> 1Y </button>
