...
<svelte:head>
	<title>Apex Area Charts | Peer Club Dashboard</title>
</svelte:head>
						...
						<div>
							...
							<div class="github-style d-flex align-items-center my-2">
								...
								<div class="flex-grow-1">
									<Link href="" class="font-size-14 text-dark fw-medium">coder</Link>
									<div class="cmeta text-muted font-size-11">
										<span class="commits text-dark fw-medium" /> commits
									</div>
								</div>
							</div>
