<script>
	...
	function convertTime(todaydate) {
		const datwe = dayjs(todaydate).format('MMM DD HH:mm');
		return datwe;
	}
			...
			xaxis: {
				...
				labels: {
					formatter: function (val) {
						// return <Time timestamp="2020-02-01" format="dddd @ h:mm A · MMMM D, YYYY" />
...
<div id="categorychart" class="apex-charts" dir="ltr" />
