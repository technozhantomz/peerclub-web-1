...
<svelte:head>
	<title>Live Auction | Peer Club Dashboard</title>
</svelte:head>
									...
									<li class="nav-item" role="presentation">
										<button
											...
											class={displayCategory === 'All'
												...
												: 'nav-link fw-medium'}>All Items</button
										>
									</li>
									<li class="nav-item" role="presentation">
										<button
											type="button"
											data-filter="upto-15"
											on:click={() => setCategory('upto-15')}
											class={displayCategory === 'upto-15'
												? 'nav-link fw-medium active'
												: 'nav-link fw-medium'}>Up to 15%</button
										>
									</li>
									<li class="nav-item" role="presentation">
										<button
											type="button"
											data-filter="upto-30"
											on:click={() => setCategory('upto-30')}
											class={displayCategory === 'upto-30'
												? 'nav-link fw-medium active'
												: 'nav-link fw-medium'}>Up to 30%</button
										>
									</li>
									<li class="nav-item" role="presentation">
										<button
											type="button"
											data-filter="upto-40"
											on:click={() => setCategory('upto-40')}
											class={displayCategory === 'upto-40'
												? 'nav-link fw-medium active'
												: 'nav-link fw-medium'}>Up to 40%</button
										>
									</li>
								</ul>
							</div>
							...
							<Card class="explore-box card-animate">
								<div class="position-relative rounded overflow-hidden">
									...
									<div class="discount-time">
										...
										<h5 id={'auction-time-' + item.id} class="mb-0 text-white" />
									</div>
								</div>
								<CardBody>
									...
									<div>
										<span class="text-muted float-end">Available: {item.available}</span>
										<span class="text-muted">Sold: {item.sold}</span>
										<div class="progress progress-sm mt-2">
											<div
												class={'progress-bar progress-bar-striped bg-' + item.progressClass}
												role="progressbar"
												...
												<div class="d-flex align-items-center">
													...
													<div class="ms-2">
														<Link href="/NFTmarketplace/Itemdetails/apps-nft-item-details"
															><h6 class="fs-15 mb-1">{item.title}</h6></Link
														>
														<p class="mb-0 text-muted">Sold at {item.price} KSH</p>
													</div>
												</div>
											</td>
