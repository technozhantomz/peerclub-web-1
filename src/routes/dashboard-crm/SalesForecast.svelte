...
<Col xxl={3} md={6}>
	<Card>
		<CardHeader class="align-items-center d-flex">
			...
			<div class="flex-shrink-0">
				<Dropdown class="card-header-dropdown">
					<DropdownToggle tag="a" color="" class="text-reset dropdown-btn p-0">
						<span class="fw-semibold text-uppercase fs-12">Sort by: </span><span class="text-muted"
							>Nov 2021<i class="mdi mdi-chevron-down ms-1" /></span
						>
					</DropdownToggle>
					<DropdownMenu end>
		...
		<div class="card-body pb-0">
			<div id="sales-forecast-chart" class="apex-charts" dir="ltr">
				<SalesForecastCharts dataColors={['--vz-primary', '--vz-success', '--vz-danger']} />
			</div>
		</div>
	</Card>
</Col>
