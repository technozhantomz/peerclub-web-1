<script>
	import { Badge, Button, Card, CardBody, CardHeader, Col, Container, Row } from 'sveltestrap';
...
<svelte:head>
	<title>Typography | Peer Club Dashboard</title>
</svelte:head>
			...
			<Col xxl={6}>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<h1 class="mb-3">
								h1. Bootstrap heading <small class="text-muted">Semibold 2.03125rem (32.5px)</small>
							</h1>
							<h2 class="mb-3">
								h2. Bootstrap heading <small class="text-muted">Semibold 1.625rem (26px)</small>
							</h2>
							<h3 class="mb-3">
								h3. Bootstrap heading <small class="text-muted">Semibold 1.42188rem (22.8px)</small>
							</h3>
							<h4 class="mb-3">
								h4. Bootstrap heading <small class="text-muted">Semibold 1.21875rem (19.5px)</small>
							</h4>
							<h5 class="mb-3">
								h5. Bootstrap heading <small class="text-muted">Semibold 1.01563rem (16.25px)</small
								>
							</h5>
							<h6 class="mb-1">
								h6. Bootstrap heading <small class="text-muted">Semibold 0.8125rem (13px)</small>
							</h6>
						</div>

						<div class="d-none code-view">
							<PrismCode code={headingsCode} id="headingsCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={displayHeadingCode} id="displayHeadingCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>&lt;blockquote class="blockquote"&gt;</code> class for quoting blocks of content
						...
						<div class="d-none code-view">
							<PrismCode code={blockquotesCode} id="blockquotesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted text-muted">
							Use <code>blockquote-</code> class with the below-mentioned color variation to set the
							blockquote background color.
						</p>
						<div class="live-preview">
							<div class="row gy-4">
								...
								<div class="col-xl-4 col-md-6">
									<blockquote
										class="blockquote custom-blockquote blockquote-secondary rounded mb-0"
									>
										<p class="text-dark mb-2">Custom Blockquote Secondary Example</p>
										<footer class="blockquote-footer mt-0">
											Angie Burt <cite title="Source Title">Designer</cite>
						...
						<div class="d-none code-view">
							<PrismCode code={blockquoteColorCode} id="blockquoteColorCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted text-muted">
							Use <code>blockquote-outline</code> class to set blockquote border color.
						</p>
						<div class="live-preview">
							<div class="row gy-4">
								<div class="col-xl-4 col-md-6">
						...
						<div class="d-none code-view">
							<PrismCode code={blockquoteBorderColorCode} id="blockquoteBorderColorCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={inlineTextCode} id="inlineTextCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>list-unstyled</code> class Remove the default list-style and left margin on
							list items (immediate children only).
							<strong>This only applies to immediate children list items</strong>, meaning you will
							need to add the class for any nested lists.
						</p>
						...
						<div class="d-none code-view">
							<PrismCode code={unstyleListCode} id="unstyleListCode" />
						</div>
					</CardBody>
				</Card>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={inlineListCode} id="inlineListCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							classes (or semantic mixins). For longer terms, you can optionally add a <code
								>.text-truncate</code
						...
						<div class="d-none code-view">
							<PrismCode code={descriptionListCode} id="descriptionListCode" />
						</div>
					</CardBody>
				</Card>
			</div>
		...
		<Row>
				...
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							...
							<div class="mt-4">
								<p class="text-muted">
									Use <code>text-nowrap</code> class to prevent text from wrapping.
								</p>
								<div class="text-nowrap border bg-light mt-3" style="width: 8rem">
									This text should overflow the parent.
								</div>
						...
						<div class="d-none code-view">
							<PrismCode code={textWrappingCode} id="textWrappingCode" />
						</div>
					</CardBody>
				</Card>
				...
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							<div>
								<p class="text-muted">
									Use <code>text-break</code> class to prevent long strings of text from breaking your
									components' layout.
								</p>
						...
						<div class="d-none code-view">
							<PrismCode code={wordBreakCode} id="wordBreakCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>fs-1</code>, <code>fs-2</code>,
						...
						<div class="d-none code-view">
							<PrismCode code={fontSizeCode} id="fontSizeCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>fst-</code>with modifier class to change font-style and Use
						...
						<div class="d-none code-view">
							<PrismCode code={fontWeightCode} id="fontWeightCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>lh-</code> with modifier class to change the line height of an element.
						</p>

						<div class="live-preview">
							<p class="lh-1">
								This is a long paragraph written to show how the line-height of an element is
								affected by our utilities. Classes are applied to the element itself or sometimes
								the parent element. These classes can be customized as needed with our utility API.
							</p>
							<p class="lh-sm">
								This is a long paragraph written to show how the line-height of an element is
								affected by our utilities. Classes are applied to the element itself or sometimes
						...
						<div class="d-none code-view">
							<PrismCode code={lineHeightCode} id="lineHeightCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={textTransformCode} id="textTransformCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							<code>text-decoration-none</code> class to decorate text in components respectively.
						</p>
						<div class="live-preview">
							<p class="text-decoration-underline">This text has a line underneath it.</p>
							<p class="text-decoration-line-through">This text has a line going through it.</p>
							<Link href="" class="text-decoration-none"
								>This link has its text decoration removed</Link
							>
						</div>
						<div class="d-none code-view">
							<PrismCode code={textDecrationCode} id="textDecrationCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>text-truncate</code> class to truncate the text with an ellipsis. Requires
						...
						<div class="d-none code-view">
							<PrismCode code={textTruncationCode} id="textTruncationCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>visible</code> or <code>invisible</code> class to show or to hide elements respectively.
						</p>
						...
						<div class="d-none code-view">
							<PrismCode code={visibilityCode} id="visibilityCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>clearfix</code> class to clear/set floated content within a container.
						</p>
						<div class="live-preview">
						...
						<div class="d-none code-view">
							<PrismCode code={clearfixCode} id="clearfixCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
