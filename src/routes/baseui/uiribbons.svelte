...
<svelte:head>
	<title>Ribbons | Peer Club Dashboard</title>
</svelte:head>
				...
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							<Row class="g-3">
								<p class="text-muted">
									Use <code>round-shape</code> class to show round-shaped ribbon.
								</p>
								<Col xxl={4}>
						...
						<div class="d-none code-view">
							<PrismCode code={roundedRibbonCode} id="roundedRibbonCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							<Row class="g-3">
								<p class="text-muted">
									Use <code>ribbon-shape</code> class to show ribbon shaped ribbon.
								</p>
								<Col xxl={4}>
									<div class="card ribbon-box border shadow-none mb-lg-0">
										<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={ribbonShapeCode} id="ribbonShapeCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							<Row class="g-3">
								<p class="text-muted">
									Use <code>ribbon-fill</code> class to show fill-shaped ribbon.
								</p>
								<Col xxl={4}>
						...
						<div class="d-none code-view">
							<PrismCode code={filledRibbonsCode} id="filledRibbonsCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
									...
									<div class="card ribbon-box border shadow-none mb-lg-0 right">
										<div class="card-body text-muted">
											...
											<p class="mb-0">
												...
												eros at volutpat. In egestas mattis dui. Aliquam mattis dictum aliquet.
												Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio. Vivamus
												pretium nec odio cursus elementum ornare.
											</p>
										</div>
									</div>
								</Col>
						...
						<div class="d-none code-view">
							<PrismCode code={boxedRibbonsCode} id="boxedRibbonsCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={ribbonsCode} id="ribbonsCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							<Row class="g-3">
								<p class="text-muted">
									Use <code>trending-ribbon</code> class to show ribbon with hovering effect.
								</p>
								<Col xxl={4}>
									<div class="card ribbon-box border shadow-none overflow-hidden mb-lg-0">
										<div class="card-body text-muted">
											<div class="ribbon ribbon-info ribbon-shape trending-ribbon">
												...
												<i class="ri-flashlight-fill text-white align-bottom float-end ms-1" />
											</div>
											<h5 class="fs-14 text-end mb-3">Ribbon Shape</h5>
											<p class="mb-0">
												Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim
								...
								<Col xxl={4}>
									<div class="card ribbon-box right border shadow-none overflow-hidden mb-lg-0">
										<div class="card-body text-muted">
											<div class="ribbon ribbon-info ribbon-shape trending-ribbon">
												<i class="ri-flashlight-fill text-white align-bottom float-start me-1" />
												<span class="trending-ribbon-text">Trending</span>
											</div>
											<h5 class="fs-14 mb-3">Ribbon Right Shape</h5>
											<p class="mb-0">
						...
						<div class="d-none code-view">
							<PrismCode code={ribbonsHoverCode} id="ribbonsHoverCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
