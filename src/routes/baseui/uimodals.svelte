...
<svelte:head>
	<title>Modals | Homepesa Mega Platformd</title>
</svelte:head>
	...
	<Container fluid>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted text-muted">A default modal Example.</p>
						...
						<div class="d-none code-view">
							<PrismCode code={defaultModalCode} id="defaultModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>modal-dialog-centered</code> class to show vertically center the modal.
						</p>
						<div class="live-preview">
							<div>
								<Button color="primary" on:click={tog_center}>Center Modal</Button>
						...
						<div class="d-none code-view">
							<PrismCode code={centeredModalCode} id="centeredModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={gridsModalCode} id="gridsModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={staticBackdropModalCode} id="staticBackdropModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={togglebetweenCode} id="togglebetweenCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={tooltipModalCode} id="tooltipModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={scrollableModalCode} id="scrollableModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
						...
						<div class="live-preview">
							<div>
								<div class="hstack gap-2 flex-wrap">
									<Button color="primary" on:click={tog_varying1}>Open Modal for Mary</Button>
									<Button color="primary" on:click={tog_varying2}>Open Modal for Jennifer</Button>
									<Button color="primary" on:click={tog_varying3}>Open Modal for Roderick</Button>
								</div>
							</div>
						</div>
						<div class="d-none code-view">
							<PrismCode code={varyingModalCode} id="varyingModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
						...
						<div class="live-preview">
							<div>
								<div class="hstack flex-wrap gap-2">
									<Button color="primary" on:click={tog_fullscreen}>Fullscreen Modal</Button>

									<Button color="info" on:click={tog_xlarge}>Extra large Modal</Button>

									<Button color="success" on:click={tog_large}>Large Modal</Button>

									<Button color="danger" on:click={tog_small}>Small Modal</Button>
								</div>
							</div>
						</div>
						<div class="d-none code-view">
							<PrismCode code={optionalModalCode} id="optionalModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted text-muted">
							Below mentioned modifier classes are used to show fullscreen modal as per minimum
							screen requirement.
						</p>
						<div class="live-preview">
							<div>
								<div class="hstack gap-2 flex-wrap">
									<Button color="primary" on:click={tog_fullscreen1}>Fullscreen modal</Button>
									<Button color="primary" on:click={tog_fullscreen_sm}>Full Screen Below sm</Button>
									<Button color="primary" on:click={tog_fullscreen_md}>Full Screen Below md</Button>
									<Button color="primary" on:click={tog_fullscreen_lg}>Full Screen Below lg</Button>
									<Button color="primary" on:click={tog_fullscreen_xl}>Full Screen Below xl</Button>
									<Button color="primary" on:click={tog_fullscreen_xxl}
										>Full Screen Below xxl</Button
									>
								</div>
							</div>
						...
						<div class="d-none code-view">
							<PrismCode code={fullscreenResponsiveCode} id="fullscreenResponsiveCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							<code>flip</code>, or <code>zoomIn</code> class to modal class to set different modal with
							animation effect respectively.
						</p>
						<div class="live-preview">
							<div>
								<div class="hstack gap-2 flex-wrap">
									<Button color="primary" on:click={tog_animationRight}>Fade In Right Modal</Button>
									<Button color="primary" on:click={tog_animationLeft}>Fade In Left Modal</Button>
									<Button color="primary" on:click={tog_animationUp}>Fade In Up Modal</Button>
									<Button color="primary" on:click={tog_animationFlip}>Flip Modal</Button>
									<Button color="primary" on:click={tog_animationZoom}>Zoom In Modal</Button>
								</div>
							</div>
						</div>
						<div class="d-none code-view">
							<PrismCode code={animationModalCode} id="animationModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div>
								<div class="hstack gap-2 flex-wrap">
									<Button color="primary" on:click={tog_positionTop}>Top Modal</Button>
									<Button color="secondary" on:click={tog_positionTopRight}>Top Right Modal</Button>
									<Button color="success" on:click={tog_positionBottom}>Bottom Modal</Button>
									<Button color="danger" on:click={tog_positionBottomRight}
										>Bottom Right Modal</Button
									>
								</div>
							</div>
						...
						<div class="d-none code-view">
							<PrismCode code={positionModalCode} id="positionModalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row class="mt-2">
			<Col lg={12}>
				...
				<Row>
					<Col xl={4} md={6}>
						<Card class="text-center border">
							<CardBody class="p-4 pb-0">
								...
								<div>
									<Button
										...
										on:click={() => tog_successMessage()}>Click me</Button
									>
								</div>
								...
								<Row class="justify-content-center mt-2">
									<Col lg={10}>
										<div>
											<img src={paymentImg} alt="Mac" class="img-fluid" />
										</div>
									</Col>
								</Row>
							</CardBody>
						...
						<Card class="text-center border">
							<CardBody class="p-4 pb-0">
								...
								<Row class="justify-content-center mt-2">
									<Col lg={10}>
										<div>
											<img src={loginImg} alt="Mac" class="img-fluid" />
										</div>
									</Col>
								</Row>
							</CardBody>
						...
						<Card class="text-center border">
							<CardBody class="p-4 pb-0">
								...
								<Row class="justify-content-center mt-2">
									<Col lg={10}>
										<div>
											<img src={subscribeImg} alt="Mac" class="img-fluid" />
										</div>
									</Col>
								</Row>
							</CardBody>
						...
						<Card class="text-center border">
							<CardBody class="p-4 pb-0">
								...
								<Row class="justify-content-center mt-2">
									<Col lg={10}>
										<div>
											<img src={signupImg} alt="Mac" class="img-fluid" />
										</div>
									</Col>
								</Row>
							</CardBody>
...
>
	...
	<ModalBody>
		...
		<p class="text-muted">
			...
			legs, pitifully thin compared with the size of the rest of him, waved about helplessly as he
...
>
	...
	<ModalBody class="text-center p-5">
		...
		<div class="mt-4">
			<h4 class="mb-3">Oops something went wrong!</h4>
			<p class="text-muted mb-4">
				The transfer was not successfully received by us. the email of the recipient wasn't correct.
			</p>
			<div class="hstack gap-2 justify-content-center">
				<Button color="light" on:click={tog_center}>Close</Button>
				<Link href="" class="btn btn-danger">Try Again</Link>
...
>
	...
	<ModalBody class="text-center p-5">
		...
		<div class="mt-4">
			...
			<div class="hstack gap-2 justify-content-center">
				<Link href="" class="btn btn-link link-success fw-medium" on:click={tog_backdrop}
					><i class="ri-close-line me-1 align-middle" /> Close</Link
				>
				<Link href="" class="btn btn-success" on:click={tog_backdrop}>Completed</Link>
			</div>
...
>
	...
	<ModalBody class="text-center p-5">
		...
		<div class="mt-4 pt-3">
			<h4 class="mb-3">Follow-Up Email</h4>
			<p class="text-muted mb-4">
				Hide this modal and show the first with the button below Automatically Send your invitees a
				follow -Up email.
			</p>
			<div class="hstack gap-2 justify-content-center">
				<Button
...
>
	...
	<ModalBody>
		...
		<p class="text-muted">
			...
			know about them triggers a popover on click.
		</p>
		<Popover placement="bottom" target="Popover" title="Common Types of Fonts">
		...
		<p class="text-muted">
			...
			{' '}<Link href="" class="tooltip-test text-decoration-underline fw-medium" id="Tooltip1">
				graphic design
			</Link>{' '} to be interested in the unusual, and that’s why using
			{' '}<Link href="" class="tooltip-test text-decoration-underline" id="Tooltip2">design</Link>
			contrasting colors in Graphic Design is a must.
		</p>
		<Tooltip placement="top" target="Tooltip1">Morton Bayer</Tooltip>
		<Tooltip placement="top" target="Tooltip2">Web Developers</Tooltip>
	</ModalBody>
	<div class="modal-footer">
		<div class="mx-auto">
			<Link href="" class="btn btn-link fw-medium"
...
>
	...
	<ModalBody>
		...
		<div class="d-flex mt-2">
			...
			<div class="flex-grow-1 ms-2 ">
				<p class="text-muted mb-0">
					...
					to combine font styles that are different but complementary, like sans serif with serif,
					short with tall, or decorative with simple. Qui photo booth letterpress, commodo enim
		...
		<div class="d-flex mt-2">
			...
			<div class="flex-grow-1 ms-2 ">
				<p class="text-muted mb-0">
					...
					and that’s why using contrasting colors in Graphic Design is a must. It’s eye-catching, it
		...
		<div class="d-flex mt-2">
			...
			<div class="flex-grow-1 ms-2 ">
				<p class="text-muted mb-0">
					Keytar raw denim keffiyeh etsy art party before they sold out master cleanse gluten-free
...
>
	...
	<div class="modal-footer">
		<Link href="" class="btn btn-link link-success fw-medium" on:click={tog_xlarge}
			><i class="ri-close-line me-1 align-middle" /> Close</Link
		>
		<Button color="primary">Save changes</Button>
	</div>
...
>
	...
	<div class="modal-footer">
		<Link href="" class="btn btn-link link-success fw-medium" on:click={tog_large}
			><i class="ri-close-line me-1 align-middle" /> Close</Link
		>
		<Button color="primary">Save changes</Button>
	</div>
...
>
	...
	<div class="modal-footer">
		<Link href="" class="btn btn-link link-success fw-medium" on:click={tog_small}
			><i class="ri-close-line me-1 align-middle" /> Close</Link
		>
		<Button color="primary">Save changes</Button>
	</div>
...
>
	...
	<ModalBody>
		<form>
			<div class="mb-3">
				...
				<Input type="text" class="form-control" id="customer-name" value="Mary" readOnly />
			</div>
			<div class="mb-3">
	...
	<div class="modal-footer">
		<Button color="light" on:click={tog_varying1}>Back</Button>
...
>
	...
	<ModalBody>
		<form>
			<div class="mb-3">
				<Label for="customer-name" class="col-form-label">Customer Name:</Label>
				<Input type="text" class="form-control" id="customer-name" value="Jennifer" readOnly />
			</div>
			<div class="mb-3">
				<Label for="message-text" class="col-form-label">Message:</Label>
				<textarea class="form-control" id="message-text" rows="4" />
	...
	<div class="modal-footer">
		<Button color="light" on:click={tog_varying2}>Back</Button>
		<Button color="primary">Send message</Button>
	</div>
</Modal>;
...
>
	...
	<ModalBody>
		<form>
			<div class="mb-3">
				<Label for="customer-name" class="col-form-label">Customer Name:</Label>
				<Input type="text" class="form-control" id="customer-name" value="Roderick" readOnly />
			</div>
			<div class="mb-3">
				<Label for="message-text" class="col-form-label">Message:</Label>
				<textarea class="form-control" id="message-text" rows="4" />
	...
	<div class="modal-footer">
		<Button color="light" on:click={tog_varying3}>Back</Button>
		<Button color="primary">Send message</Button>
	</div>
</Modal>;
...
>
	...
	<ModalBody class="text-center p-5">
		...
		<div class="mt-4">
			...
			<div class="hstack gap-2 justify-content-center">
				<Link href="" class="btn btn-link link-success fw-medium" on:click={tog_positionBottom}
					><i class="ri-close-line me-1 align-middle" /> Close</Link
				>
				<Link href="" class="btn btn-success">Completed</Link>
			</div>
...
>
	<ModalBody class="text-center p-5">
		...
		<div class="mt-2">
			...
			<p class="text-muted fs-15 mb-4">
				Successful transaction is the status of operation whose result is the payment of the amount
				paid by the customer in favor of the merchant.
			</p>
			<div class="hstack gap-2 justify-content-center">
				<button class="btn btn-primary">New transaction</button>
				<button class="btn btn-soft-success"
					><i class="ri-links-line align-bottom" /> Copy tracking link</button
				>
			</div>
		</div>
	</ModalBody>
	<div class="modal-footer bg-light p-3 justify-content-center">
		<p class="mb-0 text-muted">
			You like our service? <Link href="" class="link-secondary fw-semibold">Invite Friends</Link>
		</p>
	</div>
</Modal>
...
>
	<div class="modal-content border-0 overflow-hidden">
		<ModalBody class="login-modal p-5">
			<h5 class="text-white fs-20">Login</h5>
			<p class="text-white-50 mb-4">
				Don't have an account? <Link href="/#" class="text-white">Sign Up.</Link>
			</p>
			<div class="vstack gap-2 justify-content-center">
				<button class="btn btn-light"
					><i class="ri-google-fill align-bottom text-danger" /> Google</button
				>
				<button class="btn btn-info"><i class="ri-facebook-fill align-bottom" /> Facebook</button>
			</div>
		</ModalBody>
		<ModalBody class="p-5">
			...
			<form>
				...
				<div class="mb-3">
					...
					<div class="mt-1 text-end">
						<Link href="/authenticationInner/passwordreset/auth-pass-reset-basic"
	...
	<Row class="g-0">
		<Col lg={7}>
			<div class="modal-body p-5">
				<h2 class="lh-base">
					Subscribe now today to get <span class="text-danger">20% off</span> experiences!
				</h2>
				<p class="text-muted mb-4">
					A free bet is a bet which is provided by a betting site for a customer to place and then
					benefit from the winnings. Free bets are commonly used as welcome offers.
				</p>
				...
				<div class="form-check">
					...
					<Label class="form-check-label" htmlfor="exampleCheck1"
						>By subscribing to a particular channel or user on YouTube, you can receive instant
						updates.</Label
					>
				</div>
			</div>
...
>
	...
	<Alert color="success" class="rounded-0 mb-0">
		<p class="mb-0">
			Up to <span class="fw-semibold">50% OFF</span>, Hurry up before the stock ends
		</p>
	</Alert>
	<ModalBody>
		<form>
			...
			<div class="mb-3 form-check">
				...
				<Label class="form-check-label" htmlfor="checkTerms"
					>I agree to the <span class="fw-semibold">Terms of Service</span> and Privacy Policy</Label
				>
			</div>
			<div class="text-end">
				<button
