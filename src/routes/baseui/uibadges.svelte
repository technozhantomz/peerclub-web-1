<script>
	import { Badge, Button, Card, CardBody, Col, Container, Row } from 'sveltestrap';
...
<Badge class="badge-gradient-primary">Primary</Badge>

<Badge class="badge-gradient-secondary">Secondary</Badge>

<Badge class="badge-gradient-success">Success</Badge>

<Badge class="badge-gradient-danger">Danger</Badge>

<Badge class="badge-gradient-warning">Warning</Badge>

<Badge class="badge-gradient-info">Info</Badge>

<Badge class="badge-gradient-dark">Dark</Badge>
`;
</script>

<svelte:head>
	<title>Badges | Peer Club Dashboard</title>
</svelte:head>
		...
		<Row>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={defaultBadgesCode} id="defaultBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>badge-soft-</code> class with the below-mentioned variation to create a softer
							badge.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
						...
						<div class="d-none code-view">
							<PrismCode code={softBadgesCode} id="softBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>badge-outline-</code> class with the below-mentioned variation to create
							a badge with the outline.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<span class="badge badge-outline-primary">Primary</span>
						...
						<div class="d-none code-view">
							<PrismCode code={outlineBadgesCode} id="outlineBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>rounded-pill</code> class to make badges more rounded with a larger border-radius.
						</p>
						...
						<div class="d-none code-view">
							<PrismCode code={roundedPillBadgesCode} id="roundedPillBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							to create a badge more rounded with a soft background.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<span class="badge rounded-pill badge-soft-primary">Primary</span>
						...
						<div class="d-none code-view">
							<PrismCode code={roundSoftBadgesCode} id="roundSoftBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							<code>badge-soft-</code> with below mentioned modifier classes to make badges with border
							& soft backgorund.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
						...
						<div class="d-none code-view">
							<PrismCode code={softBorderBadgesCode} id="softBorderBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={outlinePillBadgesCode} id="outlinePillBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Badge color="primary" class="badge-label">
									<i class="mdi mdi-circle-medium" /> Primary
								</Badge>
								<Badge color="secondary" class="badge-label">
									<i class="mdi mdi-circle-medium" /> Secondary
								</Badge>
								<Badge color="success" class="badge-label">
									<i class="mdi mdi-circle-medium" /> Success
								</Badge>
								<Badge color="danger" class="badge-label">
									<i class="mdi mdi-circle-medium" /> Danger
								</Badge>
								<Badge color="warning" class="badge-label">
									<i class="mdi mdi-circle-medium" /> Warning
								</Badge>
								<Badge color="info" class="badge-label">
									<i class="mdi mdi-circle-medium" /> Info
								</Badge>
								<Badge color="dark" class="badge-label">
									<i class="mdi mdi-circle-medium" /> Dark
								</Badge>
								<Badge color="light" class="badge-label text-dark">
									<i class="mdi mdi-circle-medium" /> Light
								</Badge>
							</div>
						</div>
						<div class="d-none code-view">
							<PrismCode code={labelPillBadgesCode} id="labelPillBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the below utilities to modify a badge and position it in the corner of a link or
							button.
						</p>
						<div class="live-preview">
						...
						<div class="d-none code-view">
							<PrismCode code={buttonPositionBadgesCode} id="buttonPositionBadgesCode" />
						</div>
					</CardBody>
				</Card>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={buttonBadgesCode} id="buttonBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={htmlBadgesCode} id="htmlBadgesCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
