...
<svelte:head>
	<title>Placeholders | Peer Club Dashboard</title>
</svelte:head>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							placeholders applied to create a “loading card”.
						</p>
							...
							<Row class="justify-content-center">
								<Col xl={7}>
									<Row class="justify-content-between">
										<Col lg={5} sm={6}>
											<Card>
												<img src={img1} class="card-img-top" alt="card img" />
										...
										<Col lg={5} sm={6}>
											<Card>
												<img src={img2} class="card-img-top" alt="card dummy img" />
												<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={defaultPlaceholderCode} id="defaultPlaceholderCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>w-25,w-50,w-75</code> or
							<code>w-100</code> class to placeholder class to set different widths to the placeholder.
						</p>
						<div class="live-preview">
				...
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<Row class="gap-0">
								<Col class="col-12">
									<span class="placeholder placeholder-lg w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder placeholder-sm w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder placeholder-xs w-100" />
								</Col>
							</Row>
						</div>

						<div class="d-none code-view">
							<PrismCode code={sizingCode} id="sizingCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>bg-</code> class with the below-mentioned color variation to set a custom color.
						</p>
						<div class="live-preview">
							<Row class="g-2">
								<Col class="col-12">
								...
								<Col class="col-12">
									<span class="placeholder bg-primary w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder bg-secondary w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder bg-success w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder bg-danger w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder bg-warning w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder bg-info w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder bg-light w-100" />
								</Col>
								<Col class="col-12">
									<span class="placeholder bg-dark w-100" />
								</Col>
							</Row>
						</div>
						<div class="d-none code-view">
							<PrismCode code={colorCode} id="colorCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
