...
<svelte:head>
	<title>Media Object | Peer Club Dashboard</title>
</svelte:head>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={defultCode} id="defultCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted mb-4">
							...
							Place nested <code>d-flex align-items-start</code>
						...
						<div class="d-none code-view">
							<PrismCode code={nestingCode} id="nestingCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={mediaCode} id="mediaCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
