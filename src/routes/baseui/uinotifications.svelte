...
<Toast isOpen={toast1}>
    <ToastHeader toggle={() => (toast1 = !toast1)}>
        ...
        <span class="fw-semibold me-auto">Homepesa Club</span>
		...
		<Toast isOpen={toast11}>
			<ToastHeader toggle={() =>
				...
				<img src={logosm} class="rounded me-2"
					alt="..." height="20" />
				<strong class="me-auto">Homepesa Club</strong>
				<small style="margin-left: 150px">11 mins ago</small>
			</ToastHeader>
			<ToastBody>
				Hello, world! This is a toast message.
...
`;
	...
	const defaultnotify = () => {
		const toast = toasts.add({
			title: '',
			description: 'Welcome Back! This is a Toast Notification',
	...
	const warningnotify = () => {
		const toast = toasts.add({
			title: '',
			description: 'Warning ! Something went wrong try again',
			duration: 10000, // 0 or negative to avoid auto-remove
			placement: 'top-center',
			class: 'bg-success text-white',
			type: 'warning',
	...
	const offsetnotify = () => {
		const toast = toasts.add({
			...
			duration: 10000, // 0 or negative to avoid auto-remove
			placement: 'top-right',
			class: 'bg-success text-white m-5',
			type: 'success',
			theme: 'dark'
		});
	};
...
<svelte:head>
	<title>Notifications | Homepesa Mega Platform</title>
</svelte:head>
				...
				<Card>
					...
					<CardBody>
								...
								<Col xxl={6}>
									<div>
										...
										<div class="p-3 bg-light">
											...
											<Toast isOpen={toast4}>
												<ToastHeader toggle={() => (toast4 = !toast4)}>
													<img src={logosm} class="rounded me-2" alt="..." height="20" />
													<span class="fw-semibold me-auto">Homepesa Club</span>
							...
							<div class="mt-5">
								...
								<Row class="g-3">
									<Col xxl={6}>
										<div>
											<p class="text-muted">
												Place toasts with custom CSS as you need them. The top right is often used
												for notifications, as is the top middle. If you’re only ever going to show
												one toast at a time, put the positioning styles right on the <code
													>.toast</code
												>.
											</p>
											<div class="bg-light" style="position: relative; min-height: 200px">
						...
						<div class="d-none code-view">
							<PrismCode code={bootstrapToastsCode} id="bootstrapToastsCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
					...
					<CardBody>
						...
						<div class="live-preview">
							<Form>
								<div class="mb-3">
									<select
										...
										on:change={(e) => setPosition(e.currentTarget.value)}
									>
										<option value="" defaultValue>Select a position...</option>
										<option value="top-0 start-0">Top left</option>
										<option value="top-0 start-50 translate-middle-x">Top center</option>
							...
							<div
								aria-live="polite"
								aria-atomic="true"
								class="bd-example bg-light position-relative"
								style="min-height: 300px"
							>
								<div
									class={'toast-container position-absolute p-3 ' + position}
									id="toastPlacement"
								>
									<Toast isOpen={toast11}>
										<ToastHeader toggle={() => (toast11 = !toast11)}>
											<img src={logosm} class="rounded me-2" alt="..." height="20" />
											<strong class="me-auto">Homepesa Club</strong>
											<small style="margin-left: 150px">11 mins ago</small>
										</ToastHeader>
						...
						<div class="d-none code-view">
							<PrismCode code={toastPlacementCode} id="toastPlacementCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>toast-border-</code> with below-mentioned color variation to set a toast with
							border and icon.
						</p>
						<div class="live-preview">
							<div class="position-relative">
								<div class="hstack flex-wrap gap-2">
									<Button
										...
										on:click={() => (toast7 = !toast7)}>Primary Toast</Button
									>
									<Button
										class="btn btn-success"
										id="borderedToast2Btn"
										on:click={() => (toast8 = !toast8)}>Success Toast</Button
									>
									<Button
										class="btn btn-warning"
										id="borderedTost3Btn"
										on:click={() => (toast9 = !toast9)}>Warning Toast</Button
									>
									<Button
										class="btn btn-danger"
										id="borderedToast4Btn"
										on:click={() => (toast10 = !toast10)}>Danger Toast</Button
									>
								</div>
								...
								<div style="z-index: 11">
									...
									>
										<ToastBody>
											<div class="d-flex align-items-center">
												<div class="flex-shrink-0 me-2">
													<i class="ri-user-smile-line align-middle" />
												</div>
												<div class="flex-grow-1">
													<h6 class="mb-0">Your application was successfully sent.</h6>
												</div>
								...
								<div style="z-index: 11">
									...
									>
										<ToastBody>
											<div class="d-flex align-items-center">
												<div class="flex-shrink-0 me-2">
													<i class="ri-checkbox-circle-fill align-middle" />
												</div>
												<div class="flex-grow-1">
													<h6 class="mb-0">Yey! Everything worked!</h6>
												</div>
								...
								<div style="z-index: 11">
									...
									>
										<ToastBody>
											<div class="d-flex align-items-center">
												<div class="flex-shrink-0 me-2">
													<i class="ri-notification-off-line align-middle" />
												</div>
												<div class="flex-grow-1">
													<h6 class="mb-0">Something went wrong, try again.</h6>
												</div>
								...
								<div style="z-index: 11">
									...
									>
										<ToastBody>
											<div class="d-flex align-items-center">
												<div class="flex-shrink-0 me-2">
													<i class="ri-alert-line align-middle" />
												</div>
												<div class="flex-grow-1">
													<h6 class="mb-0">
														Something is very wrong! <Link
															href=""
															class="text-decoration-underline">See detailed report.</Link
														>
													</h6>
												</div>
											</div>
						...
						<div class="d-none code-view">
							<PrismCode code={borderIconCode} id="borderIconCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							...
							<div class="mt-4 pt-2">
								...
								<div class="hstack flex-wrap gap-2">
									...
									<Button color="light" class="w-xs" on:click={bottomleftnotify}>Bottom Left</Button
									>
									<Button color="light" class="w-xs" on:click={bottomcenternotify}
										>Bottom Center</Button
									>
									<Button color="light" class="w-xs" on:click={bottomrightnotify}
										>Bottom Right</Button
									>
								</div>
							</div>
						...
						<div class="d-none code-view">
							<PrismCode code={toastifyCode} id="toastifyCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
