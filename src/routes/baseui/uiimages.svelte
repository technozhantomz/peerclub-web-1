...
<svelte:head>
	<title>Images | Peer Club Dashboard</title>
</svelte:head>
						...
						<div class="live-preview">
							<Row>
								<Col lg={6}>
									<div class="mt-lg-0 mt-3">
										<p class="text-muted">
											Use <code>avatar-group</code> class to
								...
								<Col lg={6}>
									<div class="mt-lg-0 mt-3">
										<p class="text-muted">
											Use <code>avatar-group</code> class
											with
		...
		<Row>
			...
			<Col xl={4}>
				<Card>
					...
					<CardBody>
						<p class="card-title-desc text-muted">
							Responsive Images with <code
								>img-fluid,max-width: 100%; and height: auto;</code> to the image so that it scales with the parent width.
						</p>
