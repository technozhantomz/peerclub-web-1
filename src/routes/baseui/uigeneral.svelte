...
<svelte:head>
	<title>General | Peer Club Dashboard</title>
</svelte:head>

<UiContent />
<div class="page-content">
	<Container fluid>
		<BreadCrumb title="General" pageTitle="Base UI" />
		<Row>
			<Col lg={12}>
				<Card>
						...
						<div class="live-preview">
							<Row>
								<Col lg={6}>
									...
									<p class="text-muted">
										Use <code>Pagination</code> attribute to
							...
							<Row>
								<Col lg={6}>
									<div class="mt-4">
										...
										<p class="text-muted">
											Use <code>pagination-separated</code
										...
										<Pagination
											class="mb-3 pagination-separated"
										>
											<PaginationItem disabled>
												<PaginationLink href=""
													>←</PaginationLink
								...
								<Col lg={6}>
									<div class="mt-4">
										...
										<p class="text-muted">
											Use <code>pagination-rounded</code> class
										...
										<Pagination class="pagination-rounded mb-3">
											<PaginationItem disabled>
												<PaginationLink href=""
													>←</PaginationLink
												>
							...
							<Row>
								<Col lg={6}>
									<div>
										...
										<p class="text-muted">
											Use <code>Spinner</code> attribute for
								...
								<Col lg={6}>
									<div>
										...
										<p class="text-muted">
											Use <code>spinner-grow</code> class for
