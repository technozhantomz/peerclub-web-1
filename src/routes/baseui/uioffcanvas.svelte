			...
			<div class="acitivity-timeline p-4">
				...
				<div class="acitivity-item py-3 d-flex">
					...
					<div class="flex-grow-1 ms-3">
						...
						<p class="text-muted mb-2">
							added a new member to peerclub dashboard
						</p>
...
<svelte:head>
	<title>Offcanvas | Peer Club Dashboard</title>
</svelte:head>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>offcanvas</code> class to set a default offcanvas.
						</p>
						<div class="live-preview">
							<div class="hstack flex-wrap gap-2">
								<Link href="" class="btn btn-secondary" on:click={toggleDefultCanvas}>
									Link with href
								</Link>
								<Button color="secondary" on:click={toggleDefultCanvas}
						...
						<div class="d-none code-view">
							<PrismCode code={defaultOffcanvasCode} id="defaultOffcanvasCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>placement="start"</code> ,
							<code>placement="top"</code>,
							<code>placement="bottom"</code>, or
							<code>placement="end"</code>, to offcanvas attribute to set different Offcanvas
							Placement.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button color="primary" on:click={toggleTopCanvas}>Toggle Top Offcanvas</Button>
								<Button color="secondary" on:click={toggleRightCanvas}
									>Toggle Right Offcanvas</Button
								>
								<Button color="success" on:click={toggleBottomCanvas}
									>Toggle Bottom Offcanvas</Button
								>
								<Button color="danger" on:click={toggleLeftCanvas}>Toggle Left Offcanvas</Button>
							</div>
						</div>
						<div class="d-none code-view">
							<PrismCode code={placementOffcanvasCode} id="placementOffcanvasCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button class="btn btn-light" on:click={toggleEnableScroll}
									>Enable Body Scrolling</Button
								>
								<Button class="btn btn-light" on:click={toggleBackdrop}
									>Enable Backdrop (Default)</Button
								>
								<Button class="btn btn-light" on:click={toggleScrollBackDrop}
									>Enable Both Scrolling & Backdrop</Button
								>
							</div>
						</div>
						<div class="d-none code-view">
							<PrismCode code={backdropOffcanvasCode} id="backdropOffcanvasCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
...
>
		...
		<div data-simplebar style="height: calc(100vh - 112px);">
			<div class="acitivity-timeline p-4">
				<div class="acitivity-item d-flex">
					...
					<div class="flex-grow-1 ms-3">
						<h6 class="mb-1">
							Oliver Phillips <span class="badge bg-soft-primary text-primary align-middle"
								>New</span
							>
						</h6>
				...
				<div class="acitivity-item py-3 d-flex">
					<div class="flex-shrink-0 avatar-xs acitivity-avatar">
						<div class="avatar-title bg-soft-success text-success rounded-circle">N</div>
					</div>
					<div class="flex-grow-1 ms-3">
						<h6 class="mb-1">
						...
						<p class="text-muted mb-2">
							<i class="ri-file-text-line align-middle ms-2" /> Create new project Buildng product
						</p>
						<div class="avatar-group mb-2">
							<Link href="" class="avatar-group-item" id="Christi">
								<img src={avatar4} alt="" class="rounded-circle avatar-xs" />
							</Link>
							<Tooltip placement="top" target="Christi">Christi</Tooltip>
							<Tooltip placement="top" target="Frank">Frank Hook Ruby</Tooltip>
							<Tooltip placement="top" target="more">more</Tooltip>

							<Link href="" class="avatar-group-item" id="Frank">
								<img src={avatar3} alt="" class="rounded-circle avatar-xs" />
							</Link>
							<Tooltip placement="top" target="Frank">Frank Hook</Tooltip>
				...
				<div class="acitivity-item py-3 d-flex">
					...
					<div class="flex-grow-1 ms-3">
						<h6 class="mb-1">
							Natasha Carey <span class="badge bg-soft-success text-success align-middle"
								>Completed</span
							>
						</h6>
						...
						<Row class="border border-dashed gx-2 p-2 mb-2">
							...
							<Col class="col-4">
								<img src={img4} alt="" class="img-fluid rounded" />
							</Col>
						</Row>
						<small class="mb-0 text-muted">25 Nov</small>
					</div>
				...
				<div class="acitivity-item py-3 d-flex">
					<div class="flex-shrink-0">
						<img src={avatar6} alt="" class="avatar-xs rounded-circle acitivity-avatar" />
					</div>
					<div class="flex-grow-1 ms-3">
						<h6 class="mb-1">Bethany Johnson</h6>
						<p class="text-muted mb-2">added a new member to peerclub dashboard</p>
						<small class="mb-0 text-muted">19 Nov</small>
					</div>
				</div>
				<div class="acitivity-item py-3 d-flex">
				...
				<div class="acitivity-item py-3 d-flex">
					<div class="flex-shrink-0">
						<img src={avatar7} alt="" class="avatar-xs rounded-circle acitivity-avatar" />
					</div>
					<div class="flex-grow-1 ms-3">
						<h6 class="mb-1">Lewis Pratt</h6>
						<p class="text-muted mb-2">
				...
				<div class="acitivity-item d-flex">
					<div class="flex-shrink-0">
						<img src={avatar8} alt="" class="avatar-xs rounded-circle acitivity-avatar" />
					</div>
					<div class="flex-grow-1 ms-3">
						<h6 class="mb-1">
							New ticket received <span class="badge bg-soft-success text-success align-middle"
								>Completed</span
							>
						</h6>
						<p class="text-muted mb-2">
	...
	<div class="offcanvas-foorter border-top p-3 text-center">
		<Link href="" class="link-success"
			>View All Acitivity <i class="ri-arrow-right-s-line align-middle ms-1" /></Link
		>
	</div>
</Offcanvas>
		...
		<Row class="gallery-light">
			<Col xl={3} lg={4} sm={6}>
				<Card class="gallery-box light mb-0">
					<div class="gallery-container">
						<Link href="" title="">
							<img class="gallery-img img-fluid mx-auto" src={img12} alt="" />
							<div class="gallery-overlay">
								<h5 class="overlay-caption">
					...
					<div class="box-content">
						<div class="d-flex align-items-center mt-1">
							<div class="flex-grow-1 text-muted">
								by <Link href="" class="text-body text-truncate">Erica Kernan</Link>
							</div>
							<div class="flex-shrink-0">
								<div class="d-flex gap-3">
									<button
										...
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-thumb-up-fill text-muted align-bottom me-1" /> 3.4K
									</button>
									<button
										type="button"
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-question-answer-fill text-muted align-bottom me-1" /> 1.3K
									</button>
								</div>
							</div>
						</div>
			...
			<Col xl={3} lg={4} sm={6}>
				<Card class="gallery-box light mb-0">
					<div class="gallery-container">
						<Link href="" title="">
							<img class="gallery-img img-fluid mx-auto" src={img9} alt="" />
							<div class="gallery-overlay">
					...
					<div class="box-content">
						<div class="d-flex align-items-center mt-1">
							<div class="flex-grow-1 text-muted">
								by <Link href="" class="text-body text-truncate">Ron Mackie</Link>
							</div>
							<div class="flex-shrink-0">
								<div class="d-flex gap-3">
									<button
										...
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-thumb-up-fill text-muted align-bottom me-1" /> 5.1K
									</button>
									<button
										type="button"
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-question-answer-fill text-muted align-bottom me-1" /> 4.7K
									</button>
								</div>
							</div>
						</div>
			...
			<Col xl={3} lg={4} sm={6}>
				<Card class="gallery-box mb-0">
					<div class="gallery-container">
						<Link href="" title="">
							<img class="gallery-img img-fluid mx-auto" src={img11} alt="" />
							<div class="gallery-overlay">
					...
					<div class="box-content">
						<div class="d-flex align-items-center mt-1">
							<div class="flex-grow-1 text-muted">
								by <Link href="" class="text-body text-truncate">Nancy Martino</Link>
							</div>
							<div class="flex-shrink-0">
								<div class="d-flex gap-3">
									<button
										...
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-thumb-up-fill text-muted align-bottom me-1" /> 3.2K
									</button>
									<button
										type="button"
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-question-answer-fill text-muted align-bottom me-1" /> 1.1K
									</button>
								</div>
							</div>
						</div>
			...
			<Col xl={3} lg={4} sm={6} class="d-md-none d-xl-block">
				<Card class="gallery-box mb-0">
					<div class="gallery-container">
						<Link href="" title="">
							<img class="gallery-img img-fluid mx-auto" src={img10} alt="" />
							<div class="gallery-overlay">
					...
					<div class="box-content">
						<div class="d-flex align-items-center mt-1">
							<div class="flex-grow-1 text-muted">
								by <Link href="" class="text-body text-truncate">Henry Baird</Link>
							</div>
							<div class="flex-shrink-0">
								<div class="d-flex gap-3">
									<button
										...
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-thumb-up-fill text-muted align-bottom me-1" /> 632
									</button>
									<button
										type="button"
										class="btn btn-sm fs-12 btn-link text-body text-decoration-none px-0"
									>
										<i class="ri-question-answer-fill text-muted align-bottom me-1" /> 95
									</button>
								</div>
							</div>
						</div>
				...
				<div class="acitivity-timeline p-4">
					...
					<div class="acitivity-item py-3 d-flex">
						...
						<div class="flex-grow-1 ms-3">
							<h6 class="mb-1">
								Your order is placed <span
									class="badge bg-soft-danger text-danger align-middle ms-1">Out of Delivery</span
								>
							</h6>
							<p class="text-muted mb-2">
								These customers can rest assured their order has been placed.
					...
					<div class="acitivity-item py-3 d-flex">
						...
						<div class="flex-grow-1 ms-3">
							...
							<p class="text-muted mb-2">
								...
								<Link href="" class="link-warning text-decoration-underline">Reports Builder</Link>
							</p>
							<small class="mb-0 text-muted">15 Oct</small>
						</div>
					</div>
				...
				<div class="acitivity-timeline p-4">
					...
					<div class="acitivity-item py-3 d-flex">
						...
						<div class="flex-grow-1 ms-3">
							...
							<div class="avatar-group mb-2">
								<Link href="" class="avatar-group-item" title="" id="Christi">
									<img src={avatar4} alt="" class="rounded-circle avatar-xs" />
								</Link>
								<Tooltip placement="top" target="Christi">Christi</Tooltip>

								<Link href="" class="avatar-group-item" title="" id="Frank">
									<img src={avatar3} alt="" class="rounded-circle avatar-xs" />
								</Link>
								<Tooltip placement="top" target="Frank">Frank Hook</Tooltip>

								<Link href="" class="avatar-group-item" title="" id="Ruby">
									<div class="avatar-xs">
										<div class="avatar-title rounded-circle bg-light text-primary">R</div>
									</div>
								</Link>
								...
								<Link href="" class="avatar-group-item" title="" id="more">
									<div class="avatar-xs">
										<div class="avatar-title rounded-circle">2+</div>
									</div>
								</Link>
