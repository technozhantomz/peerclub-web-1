<script>
	import { Button, Card, CardBody, CardHeader, Col, Container, Input, Row } from 'sveltestrap';
...
<svelte:head>
	<title>Utilities | Peer Club Dashboard</title>
</svelte:head>
							...
							<div>
								...
								<div class="mt-4">
									...
									<div class="d-flex align-items-start flex-wrap gap-4">
										...
										<div class="text-center">
											<div class="border border-secondary avatar-md bg-light mx-auto mb-1" />
											<p>
						...
						<div class="live-preview">
							<div>
								<div>
									<div class="d-flex align-items-start flex-wrap gap-4">
										<div class="text-center">
											<img src={avatar2} class="avatar-md rounded" alt="rounded" />
											<p><code>.rounded</code></p>
										</div>
										<div class="text-center">
											<img src={avatar2} class="avatar-md rounded-top" alt="rounded-top" />
											<p><code>.rounded-top</code></p>
										</div>
										<div class="text-center">
											<img src={avatar2} class="avatar-md rounded-end" alt="rounded-end" />
											<p><code>.rounded-end</code></p>
										</div>
										<div class="text-center">
											<img src={avatar2} class="avatar-md rounded-bottom" alt="rounded-bottom" />
											<p><code>.rounded-bottom</code></p>
										</div>
										<div class="text-center">
											<img src={avatar2} class="avatar-md rounded-start" alt="rounded-start" />
											<p><code>.rounded-start</code></p>
										</div>
										<div class="text-center">
											<img src={avatar2} class="avatar-md rounded-circle" alt="rounded-circle" />
										...
										<div class="text-center">
											<img src={img2} class="avatar-md w-auto rounded-pill" alt="rounded-pill" />
								...
								<div>
									...
									<div class="d-flex align-items-start flex-wrap gap-4">
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-0" alt="rounded-0" />
											<p><code>.rounded-0</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-1" alt="rounded-1" />
											<p><code>.rounded-1</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-2" alt="rounded-2" />
											<p><code>.rounded-2</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-3" alt="rounded-3" />
											<p><code>.rounded-3</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-4" alt="rounded-4" />
											<p><code>.rounded-4</code></p>
										</div>
										<div class="text-center">
											<img src={avatar1} class="avatar-md rounded-5" alt="rounded-5" />
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use below-mentioned class to an element to display the value of components and more
							with our display utilities.
						</p>
						<div class="live-preview">
							<div>
								<Row>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the below-mentioned class to an element to custom display the value of components
							and more with our display utilities.
						</p>
						<div class="live-preview">
							<div>
								<div class="table-responsive">
		...
		<Row>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted mb-3">
							Use <code>vstack</code> class to create vertical layouts. Stacked items are full-width
							by default. Use <code>gap-</code> class with variation to add space between items.
						</p>
						<div class="live-preview">
							<div class="vstack gap-3">
								<div class="bg-light border p-1 px-2">First item</div>
						...
						<div class="d-none code-view">
							<PrismCode code={stacksVerticalCode} id="stacksVerticalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted mb-3">
							Use <code>hstack</code> class to create horizontal layouts. Stacked items are
							full-width by default. Use <code>gap-</code> class with variation to add space between
							items.
						</p>
						...
						<div class="d-none code-view">
							<PrismCode code={stacksHorizontalCode} id="stacksHorizontalCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={textSelectionCode} id="textSelectionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted mb-3">
							...
							<code>pe-auto</code> class to add element interactions respectively.
						</p>

						<div class="live-preview">
							<div>
								<p>
									<Link href="" class="text-success pe-none" tabIndex="-1">This link</Link> can not
									be clicked.
								</p>
								<p>
									<Link href="" class="text-success pe-auto">This link</Link> can be clicked (this is
									default behavior).
								</p>
								<p class="pe-none mb-0">
									<Link href="" class="text-success" tabIndex="-1">This link</Link> can not be clicked
									because the
									<code>pointer-events</code>
									property is inherited from its parent. However,
									<Link href="" class="pe-auto">this link</Link> has a <code>pe-auto</code> class and
									can be clicked.
								</p>
							</div>
						</div>
						...
						<div class="d-none code-view">
							<PrismCode code={pointerEventsCode} id="pointerEventsCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>overflow</code> property on the fly with four default values and classes.
						</p>
						<div class="live-preview">
							<div>
								<Row>
										...
										<div class="mt-4 mt-xl-0">
											...
											<div class="d-md-flex bg-light">
												<div class="overflow-auto p-3 mb-0 bg-light" style="height: 100px">
													...
													on an element with set width and height dimensions. By design, this content
													will vertically scroll. Lorem ipsum dolor sit amet, consectetuer adipiscing
									...
									<Col xl={3} sm={6}>
										<div class="mt-4 mt-xl-0">
											...
											<div class="d-md-flex bg-light">
												<div class="overflow-visible p-3 mb-0 bg-light" style="height: 100px">
													This is an example of using
													<code>.overflow-visible</code> on an element with set width and height dimensions.Lorem
						...
						<div class="d-none code-view">
							<PrismCode code={overflowCode} id="overflowCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
								...
								<Row>
									<Col xl={4} sm={6}>
										<div>
											...
											<div
												class="position-relative p-5 bg-light m-3 border rounded"
												style="height: 180px"
											>
						...
						<div class="d-none code-view">
							<PrismCode code={positionCode} id="positionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							While shadows on components are disabled by default in Bootstrap and can be enabled
							via <code>$enable-shadows</code>, you can also quickly add or remove a shadow with our
						...
						<div class="d-none code-view">
							<PrismCode code={shadowsCode} id="shadowsCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={widthCode} id="widthCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={heightCode} id="heightCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
