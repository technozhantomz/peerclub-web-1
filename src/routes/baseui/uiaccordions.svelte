<script>
	import { Button, Card, CardBody, Col, Collapse, Container, Row } from 'sveltestrap';
...
<svelte:head>
	<title>Accordians | Homepesa Mega Platform</title>
</svelte:head>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">A Default Accordian Example.</p>
						<div class="live-preview">
							<div class="accordion" id="default-accordion-example">
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingOne">
										<button id="collapseOne" class="accordion-button">
											How to create a group booking ?
										</button>
									</h2>

									<Collapse class="accordion-collapse" toggler="#collapseOne" isOpen>
										<div class="accordion-body">
											Although you probably won’t get into any legal trouble if you do it just once,
											why risk it? If you made your subscribers a promise, you should honor that. If
											not, you run the risk of a drastic increase in opt outs, which will only hurt
											you in the long run.
										</div>
									</Collapse>
								</div>
								<div class="accordion-item">
									...
									<Collapse class="accordion-collapse" toggler="#collapseTwo">
										<div class="accordion-body">
											No charges are put in place by SlickText when subscribers join your text list.
											This does not mean however that charges 100% will not occur. Charges that may
											occur fall under part of the compliance statement stating "Message and Data
											rates may apply."
										</div>
									</Collapse>
								</div>
								<div class="accordion-item">
									...
									<Collapse class="accordion-collapse" toggler="#collapseThree">
										<div class="accordion-body">
											Now that you have a general idea of the amount of texts you will need per
											month, simply find a plan size that allows you to have this allotment, plus
											some extra for growth. Don't worry, there are no mistakes to be made here. You
											can always upgrade and downgrade.
										</div>
									</Collapse>
								</div>
							</div>
						...
						<div class="d-none code-view">
							<PrismCode code={defaultAccordionCode} id="defaultAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>accordion-flush</code> class to remove the default background-color, some borders,
							and some rounded corners to render accordions edge-to-edge with their parent container.
						</p>
						<div class="live-preview">
							<div class="accordion" id="default-accordion-example" flush>
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingOne">
										<button
											class="accordion-button"
									...
									<Collapse class="accordion-collapse" to="#collapseFlushOne" isOpen>
										<div class="accordion-body">
											The renewal of your SlickText service happens on the anniversary of your
											original paid sign up date. Upgrading in the middle of your billing period
											will not change the billing date. Upgrading does however force an immediate,
											pro-rated charge to take place on your account.
										</div>
									</Collapse>
								</div>
								<div class="accordion-item">
									...
									<Collapse class="accordion-collapse" toggler="#collapseFlushTwo">
										<div class="accordion-body">
											If you had signed up on a free account with Slicktext, then upgraded to a paid
											plan at a later date, your bill will renew based on the date you had upgraded
											to a paid plan. All invoices are able to be viewed under your plan options in
											your SlickText account.
										</div>
									</Collapse>
								</div>
								<div class="accordion-item">
									...
									<Collapse class="accordion-collapse" toggler="#collapseFlushThree">
										<div class="accordion-body">
											No, we cannot provide this information. Opting out from a list is an
											anonymous, private act. This prevents further harassment. Providing this
											information is considered bad practice, and further communication after they
											opt out would be considered against compliance.
										</div>
									</Collapse>
								</div>
							</div>
						...
						<div class="d-none code-view">
							<PrismCode code={flushAccordionCode} id="flushAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>custom-accordionwithicon</code> class to show custom icon at accordion.
						</p>
						<div class="live-preview">
							<div
								class="accordion custom-accordionwithicon accordion-secondary"
								id="accordionWithicon"
							>
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingOne">
										<button
											...
											style="cursor: pointer"
										>
											<i class="ri-global-line me-2" /> How Does Age Verification Work?
										</button>
									</h2>

									<Collapse class="accordion-collapse" toggler="#collapseIconOne" isOpen>
										<div class="accordion-body">
											Increase or decrease the letter spacing depending on the situation and try,
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo">
										<button
											...
											style="cursor: pointer"
										>
											<i class="ri-user-location-line me-2" /> How Does Link Tracking Work?
										</button>
									</h2>

									<Collapse class="accordion-collapse" toggler="#collapseIconTwo">
										<div class="accordion-body">
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingThree">
										<button
											...
											style="cursor: pointer"
										>
											<i class="ri-pen-nib-line me-2" /> How Do I Set Up the Drip Feature?
										</button>
									</h2>
									<Collapse class="accordion-collapse" toggler="#collapseIconThree">
										<div class="accordion-body">
						...
						<div class="d-none code-view">
							<PrismCode code={iconAccordionCode} id="iconAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>accordion-icon-none</code> class to remove icon at accordion.
						</p>
						<div class="live-preview">
							<div class="accordion accordion-icon-none" id="accordionWithouticon">
								<div class="accordion-item">
									...
									>
										<div class="accordion-body">
											Each design is a new, unique piece of art birthed into this world, and while
											you have the opportunity to be creative and make your own style choices. For
											that very reason, I went on a quest and spoke to many different professional
											graphic designers.
										</div>
									</Collapse>
								</div>
								<div class="accordion-item">
									...
									>
										<div class="accordion-body">
											...
											sun strikes the upper surface of the impenetrable foliage of my trees, and but
											a few stray gleams steal into the inner sanctuary, I throw myself down among
						...
						<div class="d-none code-view">
							<PrismCode code={withIconAccordionCode} id="withIconAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>custom-accordionwithicon-plus</code> class to show plus icon at the accordion.
						</p>
						<div class="live-preview">
							<div class="accordion custom-accordionwithicon-plus" id="accordionWithplusicon">
								<div class="accordion-item">
									...
									>
										<div class="accordion-body">
											Big July earthquakes confound zany experimental vow. My girl wove six dozen
											plaid jackets before she quit. Six big devils from Japan quickly forgot how to
											waltz. try again until it looks right, and each assumenda labore aes Homo
								...
								<div class="accordion-item">
									...
									>
										<div class="accordion-body">
											...
											letter spacing depending on the situation and try, try again until it looks
											right, and each letter has the perfect spot of its own. commodo enim craft
											beer mlkshk aliquip jean shorts ullamco.
										</div>
									</Collapse>
								</div>
								<div class="accordion-item">
									...
									>
										<div class="accordion-body">
											Spacing depending on the situation and try, try again until it looks right,
											and each. next level wes anderson artisan four loko farm-to-table craft beer
											twee. commodo enim craft beer mlkshk aliquip jean shorts ullamco. omo nostrud
											organic, assumenda labore aesthetic magna delectus. pposites attract, and
											that’s a fact.
										</div>
									</Collapse>
								</div>
						...
						<div class="d-none code-view">
							<PrismCode code={plusIconAccordionCode} id="plusIconAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>lefticon-accordion</code> class to show the icon on the left side of the accordion.
						</p>
						<div class="live-preview">
							<div
								class="accordion lefticon-accordion custom-accordionwithicon accordion-border-box"
								id="accordionlefticon"
							>
								<div class="accordion-item">
						...
						<div class="d-none code-view">
							<PrismCode code={leftIconAccordionCode} id="leftIconAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>custom-accordion-border</code> class to create the border at the accordion.
						</p>
						<div class="live-preview">
							<div
						...
						<div class="d-none code-view">
							<PrismCode code={borderedAccordionCode} id="borderedAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xl={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>nesting-accordion</code> class to create a nesting accordion.
						</p>
						<div class="live-preview">
							<div
								class="accordion custom-accordionwithicon accordion-border-box"
								id="accordionnesting"
							>
								<div class="accordion-item">
									...
									>
										<div class="accordion-body">
											This opt in method is perfect for those looking to integrate a different
											software such Shopify or Hubspot with Slicktext. For example, upon cashing out
											online, a subscriber may submit to have their mobile number to receive
											marketing messages. The API will pass this information from said software over
											to Slicktext via API integration.
											<div
												class="accordion nesting2-accordion custom-accordionwithicon accordion-border-box mt-3"
												id="accordionnesting2"
											>
												<div class="accordion-item">
													...
													>
														<div class="accordion-body">
															...
															<div
																class="accordion nesting4-accordion custom-accordionwithicon accordion-border-box mt-3"
																id="accordionnesting4"
															>
																<div class="accordion-item">
												...
												<div class="accordion-item">
													...
													>
														<div class="accordion-body">
															...
															out of. If this user was to text to join again, the initial text they
															are met with will be a "welcome back" message instead of the auto
															reply.
														</div>
													</Collapse>
												</div>
								...
								<div class="accordion-item">
									...
									<Collapse toggler="#collapseNestingTwo" class="accordion-collapse">
										<div class="accordion-body">
											Personalization allows you to provide a personal touch to your outbound text
											marketing campaigns. SlickText uses merge tags as placeholders that are
											replaced with contact-specific information when a text message is sent. These
											merge tags may also be known as personalization fields.
											<div
								...
								<div class="accordion-item">
									...
									<Collapse toggler="#collapseNestingThree" class="accordion-collapse" isOpen>
										<div class="accordion-body">
											When you run out of messages, you will not be able to send any outbound
											campaigns. This would include any scheduled messages, drip campaigns, and
											birthday messages. However, we will continue to deliver your auto-reply
											messages to allow your subscriber list to continue to grow.
										</div>
									</Collapse>
								</div>
							</div>
						...
						<div class="d-none code-view">
							<PrismCode code={nestingAccordionCode} id="nestingAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
					...
					<CardBody>
						...
						<div class="live-preview">
							<Row>
								<Col xxl={6}>
									<div
										class="accordion custom-accordionwithicon accordion-fill-success"
										id="accordionFill"
									>
										<div class="accordion-item">
											...
											<Collapse class="accordion-collapse" toggler="#collapseFillOne" isOpen>
												<div class="accordion-body">
													Webhooks allow you to gather real time data on key interactions that
													happen with your Slick Text account. Simply provide us with a url where
													you'd like the data to be sent, choose which events you'd like to be
										...
										<div class="accordion-item">
											...
											<Collapse class="accordion-collapse" toggler="#collapseFillTwo">
												<div class="accordion-body">
								...
								<Col xxl={6}>
									<div
										class="accordion custom-accordionwithicon accordion-flush accordion-fill-secondary"
										id="accordionFill2"
									>
										<div class="accordion-item">
											...
											<Collapse toggler="#collapseCustomOne" class="accordion-collapse" isOpen>
												<div class="accordion-body">
													...
													commodo enim craft beer mlkshk aliquip jean shorts ullamco ad vinyl cillum
													PBR.
												</div>
											</Collapse>
										</div>
										...
										<div class="accordion-item">
											...
											>
												<div class="accordion-body">
													...
													dui quis mi consectetuer lacinia. Nam pretium turpis et arcu arcu tortor,
						...
						<div class="d-none code-view">
							<PrismCode code={fillColoredAccordionCode} id="fillColoredAccordionCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							<div class="d-flex gap-2 flex-wrap mb-3">
								<Link href="" id="collapseExample" style="cursor: pointer" class="btn btn-primary">
									Link with href{' '}
								</Link>
								<Button color="primary" id="collapseExample" style="cursor : pointer">
									Button with data-target
								</Button>
							</div>
							<Collapse toggler="#collapseExample" isOpen>
						...
						<div class="d-none code-view">
							<PrismCode code={collapseCode} id="collapseCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<div class="live-preview">
							<p>
								<Button id="collapseWidthExample" color="primary" style="cursor : pointer">
									Toggle Width Collapse
								</Button>
							</p>

							<div>
								<Collapse toggler="#collapseWidthExample" horizontal isOpen>
						...
						<div class="d-none code-view">
							<PrismCode code={horizontalCollapseCode} id="horizontalCollapseCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="hstack gap-3 mb-3">
								<Link href="" id="collapseWithicon" style="cursor: pointer" class="link-success">
									<i class="ri-arrow-down-circle-line fs-16" />
								</Link>
								<Button color="light" id="collapseWithicon2" style="cursor : pointer">
									<i class="ri-filter-2-line" />
								</Button>
							</div>
							<Collapse toggler="#collapseWithicon" isOpen>
						...
						<div class="d-none code-view">
							<PrismCode code={iconCollapseCode} id="iconCollapseCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Inline element collapse takes all horizontal space hence you can activate the collapse
							within by clicking on full-width horizontal space. Block element collapse can be
							activated by clicking on collapse toggle only.
						</p>
						<div class="live-preview">
							<div class="mb-3">
								<h6 class="text-primary" id="collapseblock">
								...
								<span role="button" class="text-primary fw-medium" id="collapseinline">
									<code>&lt;span&gt;</code> Block Element Collapse
								</span>
							</div>
							<Row class="g-2">
								<Col class="col-auto">
									<Collapse toggler="#collapseblock" horizontal isOpen>
										<div class="card card-body mb-0" style="width: 300px">
								...
								<Col class="col-auto">
									<Collapse toggler="#collapseinline" horizontal>
										<div class="card card-body mb-0" style="width: 300px">
											When you have created a new account schedule and set up the rows, you must set
											up columns.
										</div>
									</Collapse>
								</Col>
						...
						<div class="d-none code-view">
							<PrismCode code={inlineBLockCollapseCode} id="inlineBLockCollapseCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							<code>&lt;a&gt;</code>
							can show and hide multiple elements by referencing them with a selector in its href or
							data-bs-target attribute. Multiple <code>&lt;button&gt;</code> or
							<code>&lt;a&gt;</code> can show and hide an element if they each reference it with their
						...
						<div class="live-preview">
							<div class="d-flex gap-2 flex-wrap mb-3">
								...
								<Button id="multiCollapseExample2" color="primary" style="cursor : pointer">
									Toggle Second Element
								</Button>
								<Button id="multiCollapseExample2" color="primary" style="cursor : pointer">
									Toggle Both Elements
							...
							<Row>
								<Col>
									<Collapse toggler="#multiCollapseExample1" class="multi-collapse" isOpen>
										<div class="card card-body mb-0">
								...
								<Col>
									<Collapse toggler="#multiCollapseExample2" class="multi-collapse" isOpen>
										<div class="card card-body mb-0">
						...
						<div class="d-none code-view">
							<PrismCode code={multipleTargetCollapseCode} id="multipleTargetCollapseCode" />
						</div>
					</CardBody>
				</Card>
			</Col>
