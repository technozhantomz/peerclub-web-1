	...
	<Container>
		<Row class="align-items-center gy-4">
			<Col lg={6} sm={7} class="mx-auto">
				<div>
					<img src={img1} alt="" class="img-fluid mx-auto" />
				</div>
			</Col>
			<Col lg={6}>
				<div class="text-muted">
					...
					<p class="mb-4 ff-secondary fs-16">
						Collection widgets specialize in displaying many elements of the same type, such as a
						collection of pictures from a collection of articles from a news app or a collection of
...
<section class="py-5 bg-primary position-relative">
	<div class="bg-overlay bg-overlay-pattern opacity-50" />
	<Container>
		<Row class="align-items-center gy-4">
			<Col class="col-sm">
				<div>
					<h4 class="text-white mb-0 fw-semibold">Build your web App/SaaS with Peer Club dashboard</h4>
				</div>
			</Col>
			<Col class="col-sm-auto">
				<div>
					<Link
						href="https://1.envato.market/peerclub-admin"
						target="_blank"
						class="btn bg-gradient btn-danger"
						><i class="ri-shopping-cart-2-line align-middle me-1" /> Buy Now</Link
					>
				</div>
			</Col>
		</Row>
...
<section class="section">
	<Container>
			...
			<Col lg={6} class="order-2 order-lg-1">
				<div class="text-muted">
					...
					<p class="mb-4 ff-secondary">
						Quality Dashboards (QD) is a condition-specific, actionable web-based application for
						quality reporting and population management that is integrated into the Electronic
						Health Record (EHR).
					</p>
					...
					<div class="mt-4">
						<Link href="/dashboard" class="btn btn-primary"
							>Learn More <i class="ri-arrow-right-line align-middle ms-1" /></Link
						>
					</div>
				</div>
			</Col>

			<Col lg={6} sm={7} class="col-10 ms-auto order-1 order-lg-2">
				<div>
		...
		<Row class="align-items-center mt-5 pt-lg-5 gy-4">
			<Col lg={6} sm={7} class="col-10 mx-auto">
				<div>
			...
			<Col lg={6}>
				<div class="text-muted ps-lg-5">
					...
					<p class="mb-4">
						used to describe something that is known about or known to be true because there are
						many documents that describe it, prove it, etc.
					</p>
