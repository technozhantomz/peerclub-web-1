			...
			<Col lg={4}>
				<div class="d-flex p-3">
					<div class="flex-shrink-0 me-3">
						<div class="avatar-sm icon-effect">
							<div class="avatar-title bg-transparent text-success rounded-circle">
								<i class="ri-pencil-ruler-2-line fs-36" />
							</div>
						</div>
					</div>
					<div class="flex-grow-1">
						...
						<div>
							<Link href="" class="fs-13 fw-medium"
								>Learn More <i class="ri-arrow-right-s-line align-bottom" /></Link
							>
						</div>
					</div>
				</div>
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					...
					<div class="flex-grow-1">
						...
						<p class="text-muted my-3 ff-secondary">
							The collection of rules and guidelines which designers use to communicate with users
							through appealing.
						</p>
						<div>
							<Link href="" class="fs-13 fw-medium"
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					<div class="flex-shrink-0 me-3">
						<div class="avatar-sm icon-effect">
							<div class="avatar-title bg-transparent text-success rounded-circle">
								<i class="ri-lightbulb-flash-line fs-36" />
							</div>
						</div>
					</div>
					<div class="flex-grow-1">
						...
						<p class="text-muted my-3 ff-secondary">
							Business development firm that provides strategic planning, market research services
							and project.
						</p>
						<div>
							<Link href="" class="fs-13 fw-medium"
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					<div class="flex-shrink-0 me-3">
						<div class="avatar-sm icon-effect">
							<div class="avatar-title bg-transparent text-success rounded-circle">
								<i class="ri-customer-service-line fs-36" />
							</div>
						</div>
					</div>
					<div class="flex-grow-1">
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					...
					<div class="flex-grow-1">
						...
						<p class="text-muted my-3 ff-secondary">
							You usually get a broad range of options to play with. This enables you to use a
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					<div class="flex-shrink-0 me-3">
						<div class="avatar-sm icon-effect">
							<div class="avatar-title bg-transparent text-success rounded-circle">
								<i class="ri-settings-2-line fs-36" />
							</div>
						</div>
					</div>
					<div class="flex-grow-1">
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					<div class="flex-shrink-0 me-3">
						<div class="avatar-sm icon-effect">
							<div class="avatar-title bg-transparent text-success rounded-circle">
								<i class="ri-slideshow-line fs-36" />
							</div>
						</div>
					</div>
					<div class="flex-grow-1">
						...
						<p class="text-muted my-3 ff-secondary">
							Responsive design is a graphic user interface (GUI) design approach used to create
							content.
						</p>
						<div>
							<Link href="" class="fs-13 fw-medium"
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					...
					<div class="flex-grow-1">
						...
						<p class="text-muted my-3 ff-secondary">
							Google Fonts is a collection of 915 fonts, all available to use for free on your
							website.
						</p>
						<div>
							<Link href="" class="fs-13 fw-medium"
			...
			<Col lg={4}>
				<div class="d-flex p-3">
					<div class="flex-shrink-0 me-3">
						<div class="avatar-sm icon-effect">
							<div class="avatar-title bg-transparent text-success rounded-circle">
								<i class="ri-briefcase-5-line fs-36" />
							</div>
						</div>
					</div>
					<div class="flex-grow-1">
						...
						<p class="text-muted my-3 ff-secondary">
							An industrial specialist works with industrial operations to ensure that manufacturing
							facilities work.
						</p>
						<div>
							<Link href="" class="fs-13 fw-medium"
