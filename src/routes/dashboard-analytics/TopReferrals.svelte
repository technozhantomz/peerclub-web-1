		...
		<CardBody>
				...
				<Col xs={6}>
					...
					<p class="mb-0 mt-2 text-muted">
						<span class="badge badge-soft-success mb-0">
							<i class="ri-arrow-up-line align-middle" /> 15.72 %
						</span> vs. previous month
					</p>
				</Col>
				<Col xs={6}>
					<div class="text-center">
						<img src={illustrator} class="img-fluid" alt="" />
					</div>
				</Col>
			</Row>
			<div class="mt-3 pt-2">
				<div class="progress progress-lg rounded-pill">
					...
					<Progress bar color="info" value="18" />
					<Progress bar color="success" value="22" />
					<Progress bar color="warning" value="16" />
					<Progress bar color="danger" value="19" />
				</div>
			</div>
			...
			<div class="mt-3 pt-2">
				...
				<div class="d-flex">
					<div class="flex-grow-1">
						<p class="text-truncate text-muted fs-15 mb-0">
							<i class="mdi mdi-circle align-middle text-danger me-2" />Other
						</p>
					</div>
					<div class="flex-shrink-0">
			...
			<div class="mt-2 text-center">
				<a href={null} class="text-muted text-decoration-underline">Show All</a>
			</div>
		</CardBody>
	</Card>
</Col>
