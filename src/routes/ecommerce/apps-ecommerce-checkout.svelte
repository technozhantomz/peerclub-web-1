...
<svelte:head>
	<title>Checkout | Homepesa Mega Platform</title>
</svelte:head>
									...
									<div class="mt-4">
										<div class="d-flex align-items-center mb-2">
											...
											<div class="flex-shrink-0">
												...
												<Button color="success" class="btn-sm mb-3" on:click={toggle}>
													Add Address
												</Button>
											</div>
										</div>
										<Row class="gy-3">
											<Col lg={4} sm={6}>
												...
												<div class="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
													<div>
														<Link href={null} class="d-block text-body p-1 px-2" on:click={toggle}
											...
											<Col lg={4} sm={6}>
												...
												<div class="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
													<div>
														<Link class="d-block text-body p-1 px-2" on:click={toggle}
															><i class="ri-pencil-fill text-muted align-bottom me-1" />
															Edit</Link
														>
													</div>
												...
												<Col lg={6}>
													<div class="form-check card-radio">
														...
														<Label class="form-check-label" for="shippingMethod01">
															<span class="fs-21 float-end mt-2 text-wrap d-block fw-semibold"
																>Free</span
															>
											...
											<div>
												<div class="form-check card-radio">
													...
													<Label class="form-check-label" for="paymentMethod03">
														...
														>
														<span class="fs-15 text-wrap">Cash on Delivery</span>
													</Label>
												</div>
											</div>
										</Col>
						...
						<div class="table-responsive table-card">
							<Table class="table table-borderless align-middle mb-0">
								...
								<tbody>
									...
									<tr>
										<td colspan="2"
											>Discount <span class="text-muted">(PEERPLAYS15)</span>
											:
										</td>
