<script>
	...
	import { Card, CardBody, Col, Container, Input, Label, Row, Table } from 'sveltestrap';
...
<svelte:head>
	<title>Basic Tables | Peer Club Dashboard</title>
</svelte:head>
		...
		<Row>
				...
				<Card>
					...
					<CardBody>
										...
										<tr>
											...
											<td
												><Link href="" class="link-success"
													>View More <i class="ri-arrow-right-line align-middle" /></Link
												></td
											>
										</tr>
										<tr>
						...
						<div class="d-none code-view">
							<PrismCode code={DefaultTables} id="defaultTables" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>table-striped</code> class to add zebra-striping to any table row within the
							&lt;tbody&gt;.
						</p>
						<div class="live-preview">
							<div class="table-responsive">
						...
						<div class="d-none code-view">
							<PrismCode code={StrippedRow} id="strippedRow" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={12}>
				<Card>
					...
					<CardBody>
											...
											<th scope="col" style="width: 46px">
												<div class="form-check">
													<input
														...
														id="cardtableCheck"
													/>
													<Label class="form-check-label" htmlfor="cardtableCheck" />
												</div>
											</th>
											<th scope="col">ID</th>
											<th scope="col">Name</th>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck01"
													/>
													<Label class="form-check-label" htmlfor="cardtableCheck01" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2110</Link></td>
											<td>William Elmore</td>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck02"
													/>
													<Label class="form-check-label" htmlfor="cardtableCheck02" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2109</Link></td>
											<td>Georgie Winters</td>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck03"
													/>
													<Label class="form-check-label" htmlfor="cardtableCheck03" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2108</Link></td>
											<td>Whitney Meier</td>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck04"
													/>
													<Label class="form-check-label" htmlfor="cardtableCheck04" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2107</Link></td>
											<td>Justin Maier</td>
						...
						<div class="d-none code-view">
							<PrismCode code={StripedColumnsTables} id="StripedColumnsTables" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>table-dark</code> class to set dark color table body and
							<code>table-success</code>
							class to set success color table body respectively. use
							<code>table-</code> class with different color variation to set required table body color.
						</p>
						<div class="live-preview">
							<Row>
								<Col xl={6}>
										...
										<Table class="table-success table-striped table-nowrap align-middle mb-0">
											...
											<tbody>
												<tr>
													...
													<td>Nov 22, 2021</td>
													<td
														><i class="ri-checkbox-circle-line align-middle text-success" /> Subscribed</td
													>
													<td>
														<div class="hstack gap-3 flex-wrap">
															<Link href="" class="link-success fs-15"
																><i class="ri-edit-2-line" /></Link
															>
															<Link href="" class="link-danger fs-15"
																><i class="ri-delete-bin-line" /></Link
															>
														</div>
													</td>
												</tr>
												<tr>
													...
													<td>Nov 10, 2021</td>
													<td
														><i class="ri-close-circle-line align-middle text-danger" /> Unsubscribed</td
													>
													<td>
														<div class="hstack gap-3 flex-wrap">
															<Link href="" class="link-success fs-15"
						...
						<div class="d-none code-view">
							<PrismCode code={TablesColors} id="tablesColors" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col lg={12}>
				<Card>
					...
					<CardBody>
										...
										<Table class="table-hover align-middle table-nowrap mb-0">
											...
											<tbody>
												<tr>
													...
													<td
														><Link href=""
															><i class="ri-download-2-line fs-17 lh-1 align-middle" /></Link
														></td
													>
												</tr>
												<tr>
						...
						<div class="d-none code-view">
							<PrismCode code={HoverableRows} id="hoverableRows" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={12}>
				<Card>
					...
					<CardBody>
											...
											<th scope="col" style="width: 46px">
												<div class="form-check">
													<input
														...
														id="cardtableCheck"
													/>
													<Label class="form-check-label" for="cardtableCheck" />
												</div>
											</th>
											<th scope="col">ID</th>
											<th scope="col">Name</th>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck01"
													/>
													<Label class="form-check-label" for="cardtableCheck01" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2110</Link></td>
											<td>William Elmore</td>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck02"
													/>
													<Label class="form-check-label" for="cardtableCheck02" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2109</Link></td>
											<td>Georgie Winters</td>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck03"
													/>
													<Label class="form-check-label" for="cardtableCheck03" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2108</Link></td>
											<td>Whitney Meier</td>
											...
											<td>
												<div class="form-check">
													<input
														...
														id="cardtableCheck04"
													/>
													<Label class="form-check-label" for="cardtableCheck04" />
												</div>
											</td>
											<td><Link href="" class="fw-medium">#VL2107</Link></td>
											<td>Justin Maier</td>
						...
						<div class="d-none code-view">
							<PrismCode code={CardTables} id="cardTables" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<Card>
					...
					<CardBody>
											...
											<th scope="col" style="width: 42px">
												<div class="form-check">
													<input
														...
														id="activetableCheck"
													/>
													<Label class="form-check-label" for="activetableCheck" />
												</div>
											</th>
											<th scope="col">Order ID</th>
											<th scope="col">Shop</th>
											...
											<th scope="row">
												<div class="form-check">
													<input
														...
														checked
													/>
													<Label class="form-check-label" for="activetableCheck02" />
												</div>
											</th>
											<td>#744145235</td>
											<td>Shoppers</td>
										...
										<tr>
											<th scope="row">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="activetableCheck03" />
												</div>
											</th>
											<td>#9855126598</td>
											<td>Flipkart</td>
										...
										<tr>
											<th scope="row">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="activetableCheck04" />
												</div>
											</th>
											<td>#847512653</td>
											<td>Shoppers</td>
						...
						<div class="d-none code-view">
							<PrismCode code={ActiveTables} id="activeTables" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<Card>
					...
					<CardBody>
										...
										<tr>
											...
											<td>
												<div class="dropdown">
													...
													<ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
														<li>
															<Link class="dropdown-item" href="">View</Link>
														</li>
														<li>
						...
						<div class="d-none code-view">
							<PrismCode code={BorderedTables} id="borderedTables" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={TablesBorderColors} id="tablesBorderColors" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<Card>
					...
					<CardBody>
								...
								<Table class="table-borderless align-middle table-nowrap mb-0">
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="hstack gap-3 fs-15">
													<Link href="" class="link-primary"><i class="ri-settings-4-line" /></Link
													>
													<Link href="" class="link-danger"
														><i class="ri-delete-bin-5-line" /></Link
													>
												</div>
											</td>
										</tr>
						...
						<div class="d-none code-view">
							<PrismCode code={TablesWithoutBorders} id="tablesWithoutBorders" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xl="6">
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>table-sm</code> class to create any table more compact by cutting all cell padding
							in half.
						</p>
						...
						<div class="d-none code-view">
							<PrismCode code={SmallTables} id="smallTables" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>table-light</code> or
							<code>table-dark</code> class to create &lt;thead&gt; appear light or dark.
						</p>
						<div class="live-preview">
							<div class="table-responsive">
								<Table class="align-middle table-nowrap mb-0">
						...
						<div class="d-none code-view">
							<PrismCode code={TableHead} id="formtableHead" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xl={6}>
				<Card>
					...
					<CardBody>
						...
						<div class="d-none code-view">
							<PrismCode code={TableFoot} id="formTableFoot" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<div class="card">
					...
					<CardBody>
						<p class="text-muted">
							You can also put the <code>&lt;caption&gt;</code>
						...
						<div class="d-none code-view">
							<PrismCode code={Captions} id="formCaptions" />
						</div>
					</CardBody>
				</div>
			</Col>
		...
		<Row>
			<Col xl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Example of basic table nesting. Border styles, active styles, and table variants are
						...
						<div class="d-none code-view">
							<PrismCode code={TableNesting} id="tableNesting" />
						</div>
					</CardBody>
				</Card>
			</Col>
			...
			<Col xl={6}>
				<Card>
					...
					<div class="card-body">
						<p class="text-muted">
							Use <code>table-</code> class with below-mentioned color variation class within &lt;tr&gt;
							to set color on table row.
						</p>
						...
						<div class="d-none code-view">
							<PrismCode code={Variants} id="formvariants" />
						</div>
					</div>
				</Card>
			</Col>
		...
		<Row>
			<Col xl={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Table cells of <code>&lt;thead&gt;</code> are always vertical aligned to the bottom.
							Table cells in
							<code>&lt;tbody&gt;</code>
							inherit their alignment from
							<code>&lt;table&gt;</code> and are aligned to the the top by default. Use the vertical
									...
									<tbody>
										<tr>
											...
											<td
												...
												preceding cells. Use the vertical align classes to re-align where needed.
												inherit their alignment from and are aligned to the the top by default.</td
											>
										</tr>
										<tr class="align-bottom">
											<td
												>This cell inherits <code>vertical-align: bottom;</code> from the table row</td
											>
											<td
												>This cell inherits <code>vertical-align: bottom;</code> from the table row</td
											>
						...
						<div class="d-none code-view">
							<PrismCode code={VerticalAlignment} id="verticalAlignment" />
						</div>
					</CardBody>
				</Card>
			</Col>
		...
		<Row>
			<Col xl={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>table-responsive</code> class to make any table responsive across all viewports.
										...
										<tr>
											<th scope="col" style="width: 42px">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="responsivetableCheck" />
												</div>
											</th>
											<th scope="col">ID</th>
											<th scope="col">Date</th>
										...
										<tr>
											<th scope="row">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="responsivetableCheck01" />
												</div>
											</th>
											<td><Link href="#w-medium">#VZ2110</Link></td>
											<td>10 Oct, 14:47</td>
											<td class="text-success"
												><i class="ri-checkbox-circle-line fs-17 align-middle" /> Paid</td
											>
											<td>
												<div class="d-flex gap-2 align-items-center">
													<div class="flex-shrink-0">
										...
										<tr>
											<th scope="row">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="responsivetableCheck02" />
												</div>
											</th>
											<td><Link href="" class="fw-medium">#VZ2109</Link></td>
											<td>17 Oct, 02:10</td>
											...
											<td>
												<div class="d-flex gap-2 align-items-center">
													...
													<div class="flex-grow-1">Jackson Graham</div>
												</div>
											</td>
											<td>Splashify</td>
											<td>$270.60</td>
										...
										<tr>
											<th scope="row">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="responsivetableCheck03" />
												</div>
											</th>
											<td><Link href="" class="fw-medium">#VZ2108</Link></td>
											<td>26 Oct, 08:20</td>
											<td class="text-primary"
												><i class="ri-refresh-line fs-17 align-middle" /> Refunded</td
											>
											<td>
												<div class="d-flex gap-2 align-items-center">
													<div class="flex-shrink-0">
													...
													<div class="flex-grow-1">Lauren Trujillo</div>
												</div>
											</td>
											<td>Wireframing Kit for Figma</td>
											<td>$145.42</td>
										...
										<tr>
											<th scope="row">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="responsivetableCheck04" />
												</div>
											</th>
											<td><Link href="" class="fw-medium">#VZ2107</Link></td>
											<td>02 Nov, 04:52</td>
											<td class="text-danger"
												><i class="ri-close-circle-line fs-17 align-middle" /> Cancel</td
											>
											<td>
												<div class="d-flex gap-2 align-items-center">
													<div class="flex-shrink-0">
													...
													<div class="flex-grow-1">Curtis Weaver</div>
												</div>
											</td>
											<td>Wireframing Kit for Figma</td>
											<td>$170.68</td>
										...
										<tr>
											<th scope="row">
												<div class="form-check">
													...
													/>
													<Label class="form-check-label" for="responsivetableCheck05" />
												</div>
											</th>
											<td><Link href="" class="fw-medium">#VZ2106</Link></td>
											<td>10 Nov, 07:20</td>
											...
											<td>
												<div class="d-flex gap-2 align-items-center">
													...
													<div class="flex-grow-1">Jason schuller</div>
												</div>
											</td>
											<td>Splashify</td>
											<td>$350.87</td>
						...
						<div class="d-none code-view">
							<PrismCode code={ResponsiveTables} id="responsiveTables" />
						</div>
					</CardBody>
				</Card>
			</Col>
