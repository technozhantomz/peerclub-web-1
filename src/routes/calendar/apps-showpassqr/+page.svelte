<script>
	...
	const par_event_id = $page.url.searchParams.get('token');
...
<svelte:head>
	<title>Event Qr Pass | Peer Club Dashboard</title>
</svelte:head>

<div class="page-content">
	<Container fluid>
		<BreadCrumb title="Event Qr Pass" pageTitle="Apps" />
		<Row>
			<Col xs={12}>
				<Row>
					<Col xl={12}>
						<Card className="card-h-100">
							<CardBody>
								<div class="ticket inverse">
									<header>
										<div class="company-name">Peer Club Bunker Access</div>
										<div class="gate">
											<div>BLOCK A</div>
											<div>ANNEX 1</div>
										</div>
