...
<svelte:head>
	<title>Timeline | Homepesa Mega Platform</title>
</svelte:head>
				...
				<div>
					...
					<div class="timeline">
							...
							<div class="content">
								<div class="d-flex">
									...
									<div class="flex-grow-1 ms-3">
										<h5>
											@Erica245 <small class="text-muted fs-13 fw-normal">- 10 min Ago</small>
										</h5>
										<p class="text-muted mb-2">
											Wish someone a sincere ‘good luck in your new job’ with these sweet messages.
										...
										<div class="hstack gap-2">
											<Link href="" class="btn btn-sm btn-light"
												><span class="me-1">&#128293;</span> 19</Link
											>
											<Link href="" class="btn btn-sm btn-light"
												><span class="me-1">&#129321;</span> 22</Link
											>
										</div>
									</div>
								</div>
						...
						<div class="timeline-item right">
							<i class="icon ri-vip-diamond-line" />
										...
										<div class="d-flex border border-dashed p-2 rounded position-relative">
											...
											<div class="flex-grow-1 ms-2 overflow-hidden">
												<h6 class="mb-0 text-truncate">
													<Link href="" class="stretched-link">Bank Management System - PSD</Link>
												</h6>
												<small>8.78 MB</small>
											</div>
										</div>
						...
						<div class="timeline-item left">
							<i class="icon ri-gift-line" />
							<div class="date">10 Jul 2021</div>
							<div class="content">
								<h5>Create new project buildng product</h5>
								<p class="text-muted">
									Every team project can have a Homepesaclub. Use the Homepesaclub to share information with
						...
						<div class="timeline-item right">
							<i class="icon ri-shield-star-line" />
							<div class="date">18 May 2021</div>
							<div class="content">
								<h5>
									Donald Palmer <small class="text-muted fs-14 fw-normal"
										>- Has changed 2 attributes</small
									>
								</h5>
								<p class="text-muted fst-italic mb-2">
									" This is an awesome admin dashboard template. It is extremely well structured and
								...
								<div class="hstack gap-2">
									<Link href="" class="btn btn-sm bg-light"
										><span class="me-1">&#128151;</span> 35</Link
									>
									<Link href="" class="btn btn-sm btn-light"
										><span class="me-1">&#128077;</span> 10</Link
									>
									<Link href="" class="btn btn-sm btn-light"
										><span class="me-1">&#128591;</span> 10</Link
									>
						...
						<div class="timeline-item left">
							<i class="icon ri-user-smile-line" />
							<div class="date">10 Feb 2021</div>
							<div class="content">
								<h5>Homepesa Club admin dashboard templates layout upload</h5>
								<p class="text-muted">
									Powerful, clean & modern responsive bootstrap 5 admin template. The maximum file
									size for uploads in this demo :
								</p>
								<Row class="border border-dashed rounded gx-2 p-2">
									<Col xs={3}>
						...
						<div class="timeline-item right">
							<i class="icon ri-fire-line" />
							<div class="date">01 Jan 2021</div>
							<div class="content">
								<h5>
									New ticket received <span
										class="badge bg-soft-success text-success fs-11 align-middle ms-1"
										>Completed</span
									>
								</h5>
								<p class="text-muted mb-2">
									It is important for us that we receive email notifications when a ticket is
									created as our IT staff are mobile and will not always be looking at the dashboard
									for new tickets.
								</p>
								<Link href="" class="link-primary text-decoration-underline"
									>Read More <i class="ri-arrow-right-line" /></Link
								>
							</div>
						</div>
					</div>
				...
				<div>
					...
					<div class="timeline-2">
						...
						<div class="timeline-continue">
							<Row class="timeline-right">
								<Col xs={12}>
									<p class="timeline-date">02:35AM to 04:30PM</p>
								</Col>
								<Col xs={12}>
								...
								<Col xs={12}>
									<div class="timeline-box">
										<div class="timeline-text">
											<h5>Trip planning</h5>
											<p class="text-muted">
												In the trip planner, keep only one or two activities in a day if the purpose
												of the trip is to relax and take it easy during the vacation :
											</p>
											<Row class="border border-dashed rounded gx-2 p-2">
												<Col xs={3}>
													<Link href=""><img src={img7} alt="" class="img-fluid rounded" /></Link>
												</Col>
												<Col xs={3}>
													<Link href=""><img src={img3} alt="" class="img-fluid rounded" /></Link>
												</Col>
												<Col xs={3}>
													<Link href=""><img src={img10} alt="" class="img-fluid rounded" /></Link>
												</Col>
												<Col xs={3}>
													<Link href=""><img src={img9} alt="" class="img-fluid rounded" /></Link>
												</Col>
											</Row>
										</div>
									</div>
							...
							<Row class="timeline-right">
								...
								<Col xs={12}>
									<div class="timeline-box">
										<div class="timeline-text">
											<h5>Homepesa Club - Project Discussion</h5>
											<p class="text-muted mb-0">
							...
							<Row class="timeline-right">
								<Col xs={12}>
									<p class="timeline-date">10:24AM to 11:15PM</p>
								</Col>
								<Col xs={12}>
									<div class="timeline-box">
										<div class="timeline-text">
											...
											<p class="text-muted mb-0">
												A client meeting, meaning, direct collaboration and communication with a
							...
							<Row class="timeline-right">
								<Col xs={12}>
									<p class="timeline-date">9:20AM to 10:05PM</p>
								</Col>
								<Col xs={12}>
									<div class="timeline-box">
										<div class="timeline-text">
