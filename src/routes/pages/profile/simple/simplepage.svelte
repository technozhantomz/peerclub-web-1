...
<svelte:head>
	<title>Profile | Peer Club Dashboard</title>
</svelte:head>
				...
				<div class="col">
					<div class="p-2">
						...
						<div class="hstack text-white-50 gap-1">
							...
							<div>
								<i class="ri-building-line me-1 text-white-75 fs-16 align-middle" />Peerplays
							</div>
						</div>
					</div>
				</div>
												...
												<table class="table table-borderless mb-0">
													<tbody>
														...
														<tr>
															...
															<td class="text-muted">daveadame@peerclub.com</td>
														</tr>
														<tr>
												...
												<Col xs={6} md={4}>
													<div class="d-flex mt-4">
														...
														<div class="flex-grow-1 overflow-hidden">
															...
															<Link href={null} class="fw-semibold">www.peerclub.com</Link>
														</div>
													</div>
												</Col>
											</Row>
																		...
																		>
																			<div class="accordion-body ms-2 ps-5">
																				<p class="text-muted mb-2">
																					Every team project can have a peerclub. Use the peerclub to
																		...
																		<div class="accordion-header" id="heading8">
																			...
																			>
																				<div class="d-flex">
																					...
																					<div class="flex-grow-1 ms-3">
																						<h6 class="fs-14 mb-1">
																							Peer Club admin dashboard templates layout upload
																						</h6>
																						<small class="text-muted"
											...
											<div class="card profile-project-card shadow-none profile-project-primary">
												<CardBody class="p-4">
													<div class="d-flex">
														<div class="flex-grow-1 text-muted overflow-hidden">
															<h5 class="fs-15 text-truncate">
																<Link href={null} class="text-dark">Peer Club Project</Link>
															</h5>
															<p class="text-muted text-truncate mb-0">
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a href={null}>Peer Club-logo.png</a></h6>
																	</div>
																</div>
															</td>
															<td>PNG File</td>
