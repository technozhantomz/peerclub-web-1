...
<svelte:head>
	<title>Profile | Homepesa Mega Platform</title>
</svelte:head>
	...
	<Container fluid>
		...
		<div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
			<Row class="g-4">
				<div class="col-auto">
					<div class="avatar-lg">
						<img src={avatar1} alt="user-img" class="img-thumbnail rounded-circle" />
					</div>
				</div>
				...
				<div class="col">
					<div class="p-2">
						...
						<div class="hstack text-white-50 gap-1">
							...
							<div>
								<i class="ri-building-line me-1 text-white-75 fs-16 align-middle" />Homepesa
							</div>
						</div>
					</div>
				</div>
												...
												<table class="table table-borderless mb-0">
													<tbody>
														...
														<tr>
															...
															<td class="text-muted">daveadame@homepesa.org</td>
														</tr>
														<tr>
									...
									<Card>
										<CardBody>
											...
											<div class="d-flex mb-4">
												<div class="flex-shrink-0">
													<img src={img4} alt="" height="50" class="rounded" />
												</div>
												<div class="flex-grow-1 ms-3 overflow-hidden">
													<Link href={null}>
														<h6 class="text-truncate">Design your apps in your own way</h6>
													</Link>
											...
											<div class="d-flex mb-4">
												<div class="flex-shrink-0">
													<img src={img5} alt="" height="50" class="rounded" />
												</div>
												<div class="flex-grow-1 ms-3 overflow-hidden">
													<Link href={null}>
														<h6 class="text-truncate">Smartest Applications for Business</h6>
													</Link>
											...
											<div class="d-flex">
												<div class="flex-shrink-0">
													<img src={img6} alt="" height="50" class="rounded" />
												</div>
												<div class="flex-grow-1 ms-3 overflow-hidden">
													<Link href={null}>
														<h6 class="text-truncate">How to get creative in your work</h6>
													</Link>
												...
												<Col xs={6} md={4}>
													<div class="d-flex mt-4">
														...
														<div class="flex-grow-1 overflow-hidden">
															...
															<Link href={null} class="fw-semibold">www.homepesa.org</Link>
														</div>
													</div>
												</Col>
											</Row>
																		...
																		>
																			<div class="accordion-body ms-2 ps-5">
																				<p class="text-muted mb-2">
																					Every team project can have a Homepesa. Use the Homepesa to
																		...
																		<div class="accordion-header" id="heading8">
																			...
																			>
																				<div class="d-flex">
																					...
																					<div class="flex-grow-1 ms-3">
																						<h6 class="fs-14 mb-1">
																							Homepesa Club admin dashboard templates layout upload
																						</h6>
																						<small class="text-muted"
																				...
																				<div class="row mt-2">
																					<div class="col-xxl-6">
																						<div class="row border border-dashed gx-2 p-2">
																							...
																							<div class="col-3">
																								<img src={img7} alt="" class="img-fluid rounded" />
																							</div>

																							<div class="col-3">
																								<img src={img9} alt="" class="img-fluid rounded" />
																							</div>
																						</div>
																					</div>
																				</div>
									...
									<Card>
										<CardBody>
											...
											<div class="d-flex justify-content-end gap-2 mb-2">
												<div
													class="slider-button-prev swiper-button-disabled"
													tabindex="-1"
													role="button"
									...
									<div class="acitivity-timeline">
										...
										<div class="acitivity-item py-3 d-flex">
											...
											<div class="flex-grow-1 ms-3">
												...
												<p class="text-muted mb-2">added a new member to Homepesa dashboard</p>
														...
														<div class="flex-grow-1">
															<div class="d-flex align-items-center gap-2">
																...
																<div class="avatar-group">
																	<div class="avatar-group-item">
																		<div class="avatar-xs">
																			<img src={avatar1} alt="" class="rounded-circle img-fluid" />
																		</div>
																	</div>
																	<div class="avatar-group-item">
																		<div class="avatar-xs">
											...
											<div class="card profile-project-card shadow-none profile-project-success">
												<CardBody class="p-4">
													<div class="d-flex">
														...
														<div class="flex-shrink-0 ms-2">
															<div class="badge badge-soft-primary fs-11">Progress</div>
														</div>
													</div>
														...
														<div class="flex-grow-1">
															<div class="d-flex align-items-center gap-2">
																...
																<div class="avatar-group">
																	...
																	<div class="avatar-group-item">
																		<div class="avatar-xs">
																			<img src={avatar7} alt="" class="rounded-circle img-fluid" />
																		</div>
																	</div>
																	<div class="avatar-group-item">
																		<div class="avatar-xs">
																			<img src={avatar6} alt="" class="rounded-circle img-fluid" />
																		</div>
																	</div>
																	<div class="avatar-group-item">
																		<div class="avatar-xs">
											...
											<div class="card profile-project-card shadow-none profile-project-primary">
												<CardBody class="p-4">
													<div class="d-flex">
														<div class="flex-grow-1 text-muted overflow-hidden">
															<h5 class="fs-15 text-truncate">
																<Link href={null} class="text-dark">Homepesa Club Project</Link>
															</h5>
															<p class="text-muted text-truncate mb-0">
														...
														<div class="flex-grow-1">
															<div class="d-flex align-items-center gap-2">
																...
																<div class="avatar-group">
																	...
																	<div class="avatar-group-item">
																		<div class="avatar-xs">
																			<img src={avatar5} alt="" class="rounded-circle img-fluid" />
																		</div>
																	</div>
																</div>
															</div>
											...
											<div class="card profile-project-card shadow-none profile-project-success">
												<CardBody class="p-4">
													<div class="d-flex">
														...
														<div class="flex-shrink-0 ms-2">
															<div class="badge badge-soft-info fs-11">New</div>
														</div>
													</div>
											...
											<div class="card profile-project-card shadow-none profile-project-success">
												<CardBody class="p-4">
													<div class="d-flex">
														...
														<div class="flex-shrink-0 ms-2">
															<div class="badge badge-soft-primary fs-11">Process</div>
														</div>
													</div>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="avatar-sm">
																		...
																		>
																			<i class="ri-file-zip-fill" />
																		</div>
																	</div>
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0">
																			<a href={null}>Artboard-documents.zip</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0">
																			<a href={null}>Bank Management System</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a href={null}>Tour-video.mp4</a></h6>
																	</div>
																</div>
															</td>
															<td>MP4 File</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0">
																			<a href={null}>Account-statement.xsl</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0">
																			<a href={null}>Project Screenshots Collection</a>
																		</h6>
																	</div>
																</div>
															</td>
															...
															<td>
																<div class="dropdown">
																	...
																	>
																		<li>
																			<a class="dropdown-item" href={null}
																				><i class="ri-eye-fill me-2 align-middle" />View</a
																			>
																		</li>
																		<li>
																			<a class="dropdown-item" href={null}
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a href={null}>Homepesa Club-logo.png</a></h6>
																	</div>
																</div>
															</td>
															<td>PNG File</td>
