<script>
	import { Offcanvas, Form, Label, Input, Button } from 'sveltestrap';
	import Flatpickr from 'svelte-flatpickr';
	import Select from 'svelte-select';
	export let show, onCloseClick;
...
<Offcanvas placement="end" isOpen={show} {onCloseClick}>
	<div class="offcanvas-header bg-light">Leads Fliters</div>
	<!--end offcanvas-header-->
	<Form action="" class="d-flex flex-column justify-content-end h-100">
		<div class="offcanvas-body">
			<div class="mb-4">
				<Label for="datepicker-range" class="form-label text-muted text-uppercase fw-semibold mb-3"
					>Date</Label
				>
				<Flatpickr
					class="form-control"
			...
			<div class="mb-4">
				<Label for="country-select" class="form-label text-muted text-uppercase fw-semibold mb-3"
					>Country</Label
				>
				<Select className="mb-0" value={selectCountry} items={country} id="country-select" />
			</div>
			<div class="mb-4">
			...
			<div class="mb-4">
				<Label for="leadscore" class="form-label text-muted text-uppercase fw-semibold mb-3"
					>Lead Score</Label
				>
			...
			<div>
				<Label for="leads-tags" class="form-label text-muted text-uppercase fw-semibold mb-3"
					>Tags</Label
				>
				<div class="row g-3">
					<div class="col-lg-6">
		...
		<div class="offcanvas-footer border-top p-3 text-center hstack gap-2">
			<Button color="light" class="w-100">Clear Filter</Button>
			<Button color="success" class="w-100">Filters</Button>
		</div>
